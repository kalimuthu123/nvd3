...
(() {
    ...
    if (!identical(, "undefined") && !identical(, "undefined") && == "undefined") {
        d3 = require("d3");
    }
    nv.dispatch = d3.dispatch("start", "end");
    d3.functor = functor(v) {
        return identical(, "function") ? v : () {
            return v;
        };
    };
    d3.rebind = rebind(target, source, method) {
        return () {
            var value = method.apply(source, arguments);
            return identical(value, source) ? target : value;
        };
    };
    ...
    if (!Function.prototype.bind) {
        Function.prototype.bind = (oThis) {
            ...
            var aArgs = Array.prototype.slice.call(arguments, 1),
                ...
                fNOP = () {},
                fBound = () {
                    return fToBind.apply(this is fNOP && oThis ? this : oThis, aArgs.concat(Array.prototype.slice.call(arguments)));
                };
    ...
    if (nv.dev) {
        nv.dispatch.on("start", (e) {
            nv.logs.startTime = +new Date();
        });
        nv.dispatch.on("end", (e) {
    ...
    nv.log = () {
        if (nv.dev && window.console && console.log && console.log.apply) console.log.apply(console, arguments);
        else if (nv.dev && window.console && == "function" && Function.prototype.bind) {
...
*/
    ...
    if (!identical(, "undefined") && !identical(, "undefined")) {
        module.exports = nv;
    }
     ...
     */
    nv.dom.write = (callback) {
        if (!identical(window.fastdom, undefined)) {
    ...
    nv.interactiveGuideline = () {
        ...
        layer(selection) {
            selection.each((data) {
                ...
                mouseHandler() {
                    ...
                    if (isMSIE) {
                        ...
                        /*
                                            ...
                                            */
                        if (!identical(d3.event.target.tagName, "svg")) {
                    ...
                    /* If mouseX/Y is outside of the chart's bounds,
                                    ...
                                    */
                    if (identical(d3.event.type, "mouseout") || mouseX < 0 || mouseY < 0 || mouseX > availableWidth || mouseY > availableHeight || (d3.event.relatedTarget && identical(d3.event.relatedTarget.ownerSVGElement, undefined)) || mouseOutAnyReason) {
                        if (isMSIE) {
                            if (d3.event.relatedTarget && identical(d3.event.relatedTarget.ownerSVGElement, undefined) && (identical(d3.event.relatedTarget.className, undefined) || d3.event.relatedTarget.className.match(tooltip.nvPointerEventsClass))) {
                                return;
                            }
                        }
                    ...
                    var scaleIsOrdinal = identical(, "function");
                    ...
                    if (identical(d3.event.type, "dblclick")) {
                        dispatch.elementDblclick(mouseX: mouseX, mouseY: mouseY, pointXValue: pointXValue);
                    }
                    // if user single clicks the layer, fire elementClick
                    if (identical(d3.event.type, "click")) {
                        dispatch.elementClick(mouseX: mouseX, mouseY: mouseY, pointXValue: pointXValue);
                    }
                    // if user presses mouse down the layer, fire elementMouseDown
                    if (identical(d3.event.type, "mousedown")) {
                        dispatch.elementMouseDown(mouseX: mouseX, mouseY: mouseY, pointXValue: pointXValue);
                    }
                    // if user presses mouse down the layer, fire elementMouseUp
                    if (identical(d3.event.type, "mouseup")) {
                        dispatch.elementMouseUp(mouseX: mouseX, mouseY: mouseY, pointXValue: pointXValue);
                    }
                }
                ...
                layer.renderGuideLine = (x) {
                    if (!showGuideLine) return;
                    if (layer.guideLine && identical(layer.guideLine.attr("x1"), x)) return;
                    nv.dom.write(() {
                        var line = wrap.select(".nv-interactiveGuideLine").selectAll("line").data((x != null) ? [nv.utils.NaNtoZero(x)] : [], String);
                        line.enter().append("line").attr("class", "nv-guideline").attr("x1", (d) {
                            return d;
                        }).attr("x2", (d) {
                            return d;
        ...
        layer.margin = (_) {
            ...
            margin.top = != "undefined" ? _.top : margin.top;
            margin.left = != "undefined" ? _.left : margin.left;
            return layer;
        };
        layer.width = (_) {
        ...
        layer.showGuideLine = (_) {
            if (!arguments.length) return showGuideLine;
            showGuideLine = _;
            return layer;
        };
        layer.svgContainer = (_) {
    ...
    */
    nv.interactiveBisect = (values, searchVal, xAccessor) {
        "use strict";
        if (!(values is Array)) {
            return null;
        }
        ...
        if (identical(currentValue, searchVal)) {
            return index;
        }
    ...
    */
    nv.nearestValueIndex = (values, searchVal, threshold) {
        "use strict";
    ...
    */
    nv.models.tooltip = () {
        ...
        var valueFormatter = (d, i, p) {
            return d;
        };
        // Format function for the tooltip header value.
        var headerFormatter = (d) {
            return d;
        };
        var keyFormatter = (d, i) {
            return d;
        };
        ...
        var contentGenerator = (d, elem) {
            ...
            var trowEnter = tbodyEnter.selectAll("tr").data((p) {
                return p.series;
            }).enter().append("tr").classed("highlight", (p) {
                return p.highlight;
            });
            trowEnter.append("td").classed("legend-color-guide", true).append("div").style("background-color", (p) {
                return p.color;
            });
            trowEnter.append("td").classed("key", true).classed("total", (p) {
                return !!p.total;
            }).html((p, i) {
                return keyFormatter(p.key, i);
            });
            trowEnter.append("td").classed("value", true).html((p, i) {
                return valueFormatter(p.value, i, p);
            });
            trowEnter.filter((p, i) {
                return !identical(p.percent, undefined);
            }).append("td").classed("percent", true).html((p, i) {
                return "(" + d3.format("%")(p.percent) + ")";
            });
            trowEnter.selectAll("td").each((p) {
                if (p.highlight) {
            ...
            if (!identical(d.footer, undefined)) html += "<div class='footer'>" + d.footer + "</div>";
            return html;
        };
        /*
        ...
        var position = () {
            var pos = {
                "left": !identical(d3.event, null) ? d3.event.clientX : 0,
                "top": !identical(d3.event, null) ? d3.event.clientY : 0
            };
        ...
        var positionTooltip = () {
            nv.dom.read(() {
                ...
                if (hidden) {
                    ...
                    tooltip.interrupt().transition().duration(is_hidden ? 0 : duration).styleTween("transform", (d) {
                        return translateInterpolator;
                    }, "important").styleTween("-webkit-transform", (d) {
                        return translateInterpolator;
        ...
        initTooltip() {
            if (!tooltip || !tooltip.node()) {
                ...
                tooltip.enter().append("div").attr("class", "nvtooltip " + (classes ? classes : "xy-tooltip")).attr("id", id).style("top", 0).style("left", 0).style("opacity", 0).style("position", "absolute").selectAll("div, table, td, tr").classed(nvPointerEventsClass, true).classed(nvPointerEventsClass, true);
                tooltip.exit().remove();
            }
        }
        ...
        nvtooltip._options = Object.create({}, duration: {
            "get": () {
                return duration;
            },
            "set": (_) {
 ...
 */
    ...
    nv.utils.isObject = (a) {
        return !identical(a, null) && identical(, "object");
    };
    nv.utils.isFunction = (a) {
        return identical(, "function");
    };
    nv.utils.isDate = (a) {
        return identical(toString.call(a), "[object Date]");
    };
    nv.utils.isNumber = (a) {
        return !isNaN(a) && identical(, "number");
    };
    /*
Binds callback function to run when window is resized
 */
    nv.utils.windowResize = (handler) {
...
*/
    nv.utils.getColor = (color) {
        ...
        if (identical(color, undefined)) {
            return nv.utils.defaultColor();
        } else if (nv.utils.isArray(color)) {
            var color_scale = d3.scalePoint().range(color);
            return (d, i) {
                var key = identical(i, undefined) ? d : i;
...
*/
    nv.utils.customTheme = (dictionary, getKey, defaultColors) {
        ...
        return (series, index) {
            ...
            } else if (!identical(dictionary[key], undefined)) {
                return dictionary[key];
            } else {
...
*/
    nv.utils.calcApproxTextWidth = (svgTextElem) {
...
*/
    nv.utils.NaNtoZero = (n) {
        if (!nv.utils.isNumber(n) || isNaN(n) || identical(n, null) || identical(n, Infinity) || identical(n, -Infinity)) {
            return 0;
        }
        return n;
    };
...
*/
    d3.selection.prototype.watchTransition = (renderWatch) {
...
*/
    nv.utils.renderWatch = (dispatch, duration) {
        if (!(this is nv.utils.renderWatch)) {
            return new nv.utils.renderWatch(dispatch, duration);
        }
        var _duration = !identical(duration, undefined) ? duration : 250;
        var renderStack = [];
        var self = this;
        this.models = (models) {
            models = [].slice.call(arguments, 0);
            models.forEach((model) {
                model.___rendered = false;
                ((m) {
                    m.dispatch.on("renderEnd", (arg) {
                        m.___rendered = true;
        ...
        this.reset = (duration) {
            if (!identical(duration, undefined)) {
                _duration = duration;
            }
            renderStack = [];
        };
        this.transition = (selection, args, duration) {
            args = arguments.length > 1 ? [].slice.call(arguments, 1) : [];
            if (args.length > 1) {
                duration = args.pop();
            } else {
                duration = !identical(_duration, undefined) ? _duration : 250;
            }
            selection.___rendered = false;
            if (renderStack.indexOf(selection) < 0) {
                renderStack.push(selection);
            }
            if (identical(duration, 0)) {
                selection.___rendered = true;
                selection.delay = () {
                    return this;
                };
                selection.duration = () {
                ...
                if (identical(selection.length, 0)) {
                    selection.___rendered = true;
                } else if (selection.filter((d) {
                        return !d.length;
                    })) {
                    selection.___rendered = true;
                } else {
                ...
                var n = 0;
                return selection.transition().duration(duration).each(() {
                    ++n;
                }).on("end", (d, i) {
                    if (identical(--n, 0)) {
                        selection.___rendered = true;
        ...
        this.renderEnd = () {
            if (renderStack.every((d) {
                    return d.___rendered;
                })) {
                renderStack.forEach((d) {
                    d.___rendered = false;
                });
...
*/
    nv.utils.state = () {
        ...
        var _set = () {
            ...
            if (identical(JSON.stringify(settings), JSON.stringify(state))) {
                return false;
            }
            for (var key in settings) {
                if (identical(state[key], undefined)) {
                    state[key] = {};
                }
...
*/
    nv.utils.optionsFunc = (args) {
        if (args) {
            d3.map(args).forEach(((key, value) {
...
*/
    ...
    */
    nv.utils.calcTicksY = (numTicks, data, getY) {
        if (getY) {
            var numValues = 1;
...
*/
    nv.utils.inheritOptionsD3 = (target, d3_source, oplist) {
        target._d3options = oplist.concat(target._d3options || []);
        // Find unique d3 options (string) and update d3options
        target._d3options = (target._d3options || []).filter((item, i, ar) {
            return identical(ar.indexOf(item), i);
        });
...
*/
    nv.utils.arrayUnique = (a) {
        return a.sort().filter((item, pos) {
 ...
 */
    nv.utils.symbol = () {
        ...
        symbol(d, i) {
            ...
            if (identical(nv.utils.symbolMap.get(t), undefined)) {
...
*/
    nv.utils.sanitizeHeight = (height, container) {
...
*/
    nv.utils.availableWidth = (width, container, margin) {
...
*/
    nv.utils.noData = (chart, container) {
        ...
        noDataText.attr("x", x).attr("y", y).text((t) {
            return t;
        });
    };
    /*
    Wrap long labels.
    */
    nv.utils.wrapTicks = (text, width) {
        text.each(() {
            var text = d3.select(this),
                words = text.text().split(new RegExp(r '\s+')).reverse(),
                word, line = [],
                lineNumber = 0,
                lineHeight = 1.1,
                y = text.attr("y"),
...
*/
    nv.utils.arrayEquals = (array1, array2) {
        if (identical(array1, array2)) return true;
    ...
    */
    ...
    nv.models.axis = () {
        ...
        var margin = {
            ...
            tickFormatMaxMin;
        axis.scale(scale).orient("bottom").tickFormat((d) {
            return d;
        });
        //============================================================
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                var g = wrap.select("g");
                if (!identical(ticks, null)) axis.ticks(ticks);
                else if (axis.orient() == "top" || axis.orient() == "bottom") axis.ticks(Math.abs(scale.range()[1] - scale.range()[0]) / 100);
                ...
                if (!identical(fontSize, undefined)) {
                ...
                switch (axis.orient()) {
                    case "top":
                        ...
                        w = 0;
                        if (identical(scale.range().length, 1)) {
                            w = isOrdinal ? scale.range()[0] * 2 + scale.rangeBand() : 0;
                        } else if (identical(scale.range().length, 2)) {
                        ...
                        if (showMaxMin) {
                            ...
                            axisMaxMin.enter().append("g").attr("class", (d, i) {
                                return ["nv-axisMaxMin", "nv-axisMaxMin-x", (i == 0 ? "nv-axisMin-x" : "nv-axisMax-x")].join(" ");
                            }).append("text");
                            axisMaxMin.exit().remove();
                            axisMaxMin.attr("transform", (d, i) {
                                return "translate(" + nv.utils.NaNtoZero(scale(d)) + ",0)";
                            }).select("text").attr("dy", "-0.5em").attr("y", -axis.tickPadding()).attr("text-anchor", "middle").text((d, i) {
                                var formatter = tickFormatMaxMin || fmt;
                                var v = formatter(d);
                                return ("" + v).match("NaN") ? "" : v;
                            });
                            axisMaxMin.watchTransition(renderWatch, "min-max top").attr("transform", (d, i) {
                    ...
                    case "bottom":
                        ...
                        if (showMaxMin) {
                            ...
                            axisMaxMin = wrap.selectAll("g.nv-axisMaxMin").data([scale.domain()[0], scale.domain()[scale.domain().length - 1]]);
                            axisMaxMin.enter().append("g").attr("class", (d, i) {
                                return ["nv-axisMaxMin", "nv-axisMaxMin-x", (i == 0 ? "nv-axisMin-x" : "nv-axisMax-x")].join(" ");
                            }).append("text");
                            axisMaxMin.exit().remove();
                            ...
                            }).select("text").attr("dy", ".71em").attr("y", axis.tickPadding()).attr("transform", rotateLabelsRule).style("text-anchor", rotateLabels ? (rotateLabels % 360 > 0 ? "start" : "end") : "middle").text((d, i) {
                                var formatter = tickFormatMaxMin || fmt;
                                var v = formatter(d);
                                return ("" + v).match("NaN") ? "" : v;
                            });
                            axisMaxMin.watchTransition(renderWatch, "min-max bottom").attr("transform", (d, i) {
                                return "translate(" + nv.utils.NaNtoZero((scale(d) + (isOrdinal ? scale.rangeBand() / 2 : 0))) + ",0)";
                            });
                        }
                        break;
                    case "right":
                        axisLabel.enter().append("text").attr("class", "nv-axislabel");
                        axisLabel.style("text-anchor", rotateYLabel ? "middle" : "begin").attr("transform", rotateYLabel ? "rotate(90)" : "").attr("y", rotateYLabel ? (-Math.max(margin.right, width) + 12 - (axisLabelDistance || 0)) : -10).attr("x", rotateYLabel ? (d3.max(scale.range()) / 2) : axis.tickPadding());
                        if (showMaxMin) {
                            axisMaxMin = wrap.selectAll("g.nv-axisMaxMin").data(scale.domain());
                            axisMaxMin.enter().append("g").attr("class", (d, i) {
                            ...
                            }).select("text").attr("dy", ".32em").attr("y", 0).attr("x", axis.tickPadding()).style("text-anchor", "start").text((d, i) {
                                var formatter = tickFormatMaxMin || fmt;
                                var v = formatter(d);
                                return ("" + v).match("NaN") ? "" : v;
                            });
                            axisMaxMin.watchTransition(renderWatch, "min-max right").attr("transform", (d, i) {
                    ...
                    case "left":
                        ...
                        if (showMaxMin) {
                            ...
                            }).select("text").attr("dy", ".32em").attr("y", 0).attr("x", -axis.tickPadding()).attr("text-anchor", "end").text((d, i) {
                                var formatter = tickFormatMaxMin || fmt;
                                var v = formatter(d);
                                return ("" + v).match("NaN") ? "" : v;
                            });
                ...
                if (showMaxMin && (identical(axis.orient(), "left") || identical(axis.orient(), "right"))) {
                    //check if max and min overlap other values, if so, hide the values that overlap
                    g.selectAll("g").each((d, i) {
                    ...
                    if (scale.domain()[0] == scale.domain()[1] && scale.domain()[0] == 0) {
                        wrap.selectAll("g.nv-axisMaxMin").style("opacity", (d, i) {
                            return !i ? 1 : 0;
                        });
                    }
                }
                if (showMaxMin && (identical(axis.orient(), "top") || identical(axis.orient(), "bottom"))) {
                    var maxMinRange = [];
                    wrap.selectAll("g.nv-axisMaxMin").each((d, i) {
                        try {
                            if (i) maxMinRange.push(scale(d) - this.getBoundingClientRect().width - 4);
                ...
                g.selectAll(".tick").filter((d) {
                    /*
                                       ...
                                       */
                    return !parseFloat(Math.round(d * 100000) / 1000000) && (!identical(d, undefined));
                }).classed("zero", true);
        ...
        chart.options = nv.utils.optionsFunc.bind(chart);
        chart._options = Object.create({}, axisLabelDistance: {
            "get": () {
            ...
            "set": (_) {
                margin.top = !identical(_.top, undefined) ? _.top : margin.top;
                margin.right = !identical(_.right, undefined) ? _.right : margin.right;
                margin.bottom = !identical(_.bottom, undefined) ? _.bottom : margin.bottom;
                margin.left = !identical(_.left, undefined) ? _.left : margin.left;
            }
        }, duration: {
            "get": () {
                return duration;
    ...
    nv.models.boxPlot = () {
        ...
        var margin = {
            ...
            container = null,
            xDomain, xRange, yDomain, yRange, dispatch = d3.dispatch("elementMouseover", "elementMouseout", "elementMousemove", "renderEnd"),
            duration = 250,
            maxBoxWidth = null;
        //============================================================
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                nv.utils.initSVG(container);
                // Setup Scales
                xScale.domain(xDomain || data.map((d, i) {
                    return getX(d, i);
                ...
                var boxplots = wrap.selectAll(".nv-boxplot").data((d) {
                    return d;
                });
                var boxEnter = boxplots.enter().append("g").style("stroke-opacity", 1e-6).style("fill-opacity", 1e-6);
                boxplots.attr("class", "nv-boxplot").attr("transform", (d, i, j) {
                    return "translate(" + (xScale(getX(d, i)) + xScale.rangeBand() * 0.05) + ", 0)";
                }).classed("hover", (d) {
                    return d.hover;
                });
                boxplots.watchTransition(renderWatch, "nv-boxplot: boxplots").style("stroke-opacity", 1).style("fill-opacity", 0.75).delay((d, i) {
                ...
                boxEnter.each((d, i) {
                    ...
                    [getWl, getWh].forEach((f) {
                        if (!identical(f(d), undefined) && !identical(f(d), null)) {
                            var key = (identical(f, getWl)) ? "low" : "high";
                ...
                var box_width = () {
                    return (identical(maxBoxWidth, null) ? xScale.rangeBand() * 0.9 : Math.min(75, xScale.rangeBand() * 0.9));
                };
                var box_left = () {
                ...
                [getWl, getWh].forEach((f) {
                    var key = (identical(f, getWl)) ? "low" : "high";
                    var endpoint = (identical(f, getWl)) ? getQ1 : getQ3;
                    boxplots.select("line.nv-boxplot-whisker.nv-boxplot-" + key).watchTransition(renderWatch, "nv-boxplot: boxplots").attr("x1", xScale.rangeBand() * 0.45).attr("y1", (d, i) {
                        return yScale(f(d));
                    }).attr("x2", xScale.rangeBand() * 0.45).attr("y2", (d, i) {
                        return yScale(endpoint(d));
                    });
                    boxplots.select("line.nv-boxplot-tick.nv-boxplot-" + key).watchTransition(renderWatch, "nv-boxplot: boxplots").attr("x1", box_left).attr("y1", (d, i) {
                        return yScale(f(d));
                    }).attr("x2", box_right).attr("y2", (d, i) {
                        return yScale(f(d));
                    });
                });
                [getWl, getWh].forEach((f) {
                    var key = (identical(f, getWl)) ? "low" : "high";
                    boxEnter.selectAll(".nv-boxplot-" + key).on("mouseover", (d, i, j) {
                        d3.select(this).classed("hover", true);
                        dispatch.elementMouseover(series: {
                            "key": f(d),
                            "color": getColor(d) || color(d, j)
                        }, e: d3.event);
                    }).on("mouseout", (d, i, j) {
                        d3.select(this).classed("hover", false);
                        dispatch.elementMouseout(series: {
                            "key": f(d),
                            "color": getColor(d) || color(d, j)
                        }, e: d3.event);
                    }).on("mousemove", (d, i) {
                ...
                // boxes
                boxEnter.append("rect").attr("class", "nv-boxplot-box").on("mouseover", (d, i) {
                    d3.select(this).classed("hover", true);
                    dispatch.elementMouseover(key: getX(d), value: getX(d), series: [{
                        "key": "Q3",
                        "value": getQ3(d),
                        ...
                        "value": getQ1(d),
                        "color": getColor(d) || color(d, i)
                    }], data: d, index: i, e: d3.event);
                }).on("mouseout", (d, i) {
                    d3.select(this).classed("hover", false);
                    dispatch.elementMouseout(key: getX(d), value: getX(d), series: [{
                        "key": "Q3",
                        "value": getQ3(d),
                        "color": getColor(d) || color(d, i)
                    }, {
                ...
                // box transitions
                boxplots.select("rect.nv-boxplot-box").watchTransition(renderWatch, "nv-boxplot: boxes").attr("y", (d, i) {
                    return yScale(getQ3(d));
                }).attr("width", box_width).attr("x", box_left).attr("height", (d, i) {
                ...
                boxplots.select("line.nv-boxplot-median").watchTransition(renderWatch, "nv-boxplot: boxplots line").attr("x1", box_left).attr("y1", (d, i) {
                    return yScale(getQ2(d));
                }).attr("x2", box_right).attr("y2", (d, i) {
                    return yScale(getQ2(d));
                });
                // outliers
                var outliers = boxplots.selectAll(".nv-boxplot-outlier").data((d) {
                    return getOlItems(d) || [];
                });
                outliers.enter().append("circle").style("fill", (d, i, j) {
                    return getOlColor(d, i, j) || color(d, j);
                }).style("stroke", (d, i, j) {
                    return getOlColor(d, i, j) || color(d, j);
                }).style("z-index", 9000).on("mouseover", (d, i, j) {
                    d3.select(this).classed("hover", true);
                    dispatch.elementMouseover(series: {
                ...
                outliers.watchTransition(renderWatch, "nv-boxplot: nv-boxplot-outlier").attr("cx", xScale.rangeBand() * 0.45).attr("cy", (d, i, j) {
        ...
        chart.dispatch = dispatch;
        chart.options = nv.utils.optionsFunc.bind(chart);
        chart._options = Object.create({}, width: {
            "get": () {
                return width;
            },
            "set": (_) {
    ...
    nv.models.boxPlotChart = () {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                if (!data || !data.length) {
                    ...
                    noDataText.enter().append("text").attr("class", "nvd3 nv-noData").attr("dy", "-.7em").style("text-anchor", "middle");
                    noDataText.attr("x", margin.left + availableWidth / 2).attr("y", margin.top + availableHeight / 2).text((d) {
                        return d;
                    });
                    return chart;
                } else {
                ...
                var barsWrap = g.select(".nv-barsWrap").datum(data.filter((d) {
                    return !d.disabled;
                }));
                ...
                if (showXAxis) {
                    ...
                    if (staggerLabels) {
                        xTicks.selectAll("text").attr("transform", (d, i, j) {
                            return "translate(0," + (identical(j % 2, 0) ? "5" : "17") + ")";
                        });
                    }
                }
                if (showYAxis) {
        ...
        //------------------------------------------------------------
        boxplot.dispatch.on("elementMouseover.tooltip", (evt) {
            tooltip.data(evt).hidden(false);
        });
        boxplot.dispatch.on("elementMouseout.tooltip", (evt) {
            tooltip.data(evt).hidden(true);
        });
        boxplot.dispatch.on("elementMousemove.tooltip", (evt) {
            tooltip();
        });
        //============================================================
    ...
    nv.models.bullet = () {
        ...
        chart(selection) {
            selection.each((d, i) {
                ...
                g.select("rect.nv-measure").style("fill", color).attr("height", availableHeight / 3).attr("y", availableHeight / 3).on("mouseover", () {
                    dispatch.elementMouseover(value: measurez[0], label: measureLabelz[0] || "Current", color: d3.select(this).style("fill"));
                }).on("mousemove", () {
                    dispatch.elementMousemove(value: measurez[0], label: measureLabelz[0] || "Current", color: d3.select(this).style("fill"));
                }).on("mouseout", () {
                    dispatch.elementMouseout(value: measurez[0], label: measureLabelz[0] || "Current", color: d3.select(this).style("fill"));
                }).transition().duration(duration).attr("width", measurez < 0 ? x1(0) - x1(measurez[0]) : x1(measurez[0]) - x1(0)).attr("x", xp1(measurez));
                var h3 = availableHeight / 6;
                var markerData = markerz.map((marker, index) {
                    return {
                        "value": marker,
                ...
                gEnter.selectAll("path.nv-markerTriangle").data(markerData).enter().append("path").attr("class", "nv-markerTriangle").attr("d", "M0," + h3 + "L" + h3 + "," + (-h3) + " " + (-h3) + "," + (-h3) + "Z").on("mouseover", (d) {
                    dispatch.elementMouseover(value: d.value, label: d.label || "Previous", color: d3.select(this).style("fill"), pos: [x1(d.value), availableHeight / 2]);
                }).on("mousemove", (d) {
                    dispatch.elementMousemove(value: d.value, label: d.label || "Previous", color: d3.select(this).style("fill"));
                }).on("mouseout", (d, i) {
                    dispatch.elementMouseout(value: d.value, label: d.label || "Previous", color: d3.select(this).style("fill"));
                });
                g.selectAll("path.nv-markerTriangle").data(markerData).transition().duration(duration).attr("transform", (d) {
                    return "translate(" + x1(d.value) + "," + (availableHeight / 2) + ")";
                });
                var markerLinesData = markerLinez.map((marker, index) {
                    return {
                        "value": marker,
                        "label": markerLineLabelz[index]
                    };
                });
                gEnter.selectAll("line.nv-markerLine").data(markerLinesData).enter().append("line").attr("cursor", "").attr("class", "nv-markerLine").attr("x1", (d) {
                    return x1(d.value);
                }).attr("y1", "2").attr("x2", (d) {
                    return x1(d.value);
                }).attr("y2", availableHeight - 2).on("mouseover", (d) {
                    dispatch.elementMouseover(value: d.value, label: d.label || "Previous", color: d3.select(this).style("fill"), pos: [x1(d.value), availableHeight / 2]);
                }).on("mousemove", (d) {
                    dispatch.elementMousemove(value: d.value, label: d.label || "Previous", color: d3.select(this).style("fill"));
                }).on("mouseout", (d, i) {
                ...
                g.selectAll("line.nv-markerLine").data(markerLinesData).transition().duration(duration).attr("x1", (d) {
                    return x1(d.value);
                }).attr("x2", (d) {
                    return x1(d.value);
                });
                wrap.selectAll(".nv-range").on("mouseover", (d, i) {
                    ...
                    dispatch.elementMouseover(value: d, label: label, color: d3.select(this).style("fill"));
                }).on("mousemove", () {
                    dispatch.elementMousemove(value: measurez[0], label: measureLabelz[0] || "Previous", color: d3.select(this).style("fill"));
                }).on("mouseout", (d, i) {
                    var label = rangeLabelz[i] || defaultRangeLabels[i];
                    dispatch.elementMouseout(value: d, label: label, color: d3.select(this).style("fill"));
                });
            });
            return chart;
        }
        ...
        chart.dispatch = dispatch;
        chart.options = nv.utils.optionsFunc.bind(chart);
        chart._options = Object.create({}, ranges: {
            "get": () {
                return ranges;
            },
            "set": (_) {
    ...
    nv.models.bulletChart = () {
        ...
        chart(selection) {
            selection.each((d, i) {
                ...
                title.append("text").attr("class", "nv-title").text((d) {
                    return d.title;
                });
                title.append("text").attr("class", "nv-subtitle").attr("dy", "1em").text((d) {
                    return d.subtitle;
                });
                ...
                var tick = g.selectAll("g.nv-tick").data(x1.ticks(ticks ? ticks : (availableWidth / 50)), (d) {
                    return this.textContent || format(d);
                });
                // Initialize the ticks with the old scale, x0.
                var tickEnter = tick.enter().append("g").attr("class", "nv-tick").attr("transform", (d) {
                ...
                var tickUpdate = d3.transition(tick).transition().duration(bullet.duration()).attr("transform", (d) {
                ...
                d3.transition(tick.exit()).transition().duration(bullet.duration()).attr("transform", (d) {
                    return "translate(" + x1(d) + ",0)";
    ...
    nv.models.candlestickBar = () {
        ...
        chart(selection) {
            selection.each((data) {
                ...
                if (padData) x.range(xRange || [availableWidth * .5 / data[0].values.length, availableWidth * (data[0].values.length - .5) / data[0].values.length]);
                ...
                if (identical(x.domain()[0], x.domain()[1])) x.domain()[0] ? x.domain([x.domain()[0] - x.domain()[0] * 0.01, x.domain()[1] + x.domain()[1] * 0.01]) : x.domain([-1, 1]);
                if (identical(y.domain()[0], y.domain()[1])) y.domain()[0] ? y.domain([y.domain()[0] + y.domain()[0] * 0.01, y.domain()[1] - y.domain()[1] * 0.01]) : y.domain([-1, 1]);
                // Setup containers and skeleton of chart
                ...
                var ticks = wrap.select(".nv-ticks").selectAll(".nv-tick").data((d) {
                    return d;
                });
                ticks.exit().remove();
                var tickGroups = ticks.enter().append("g");
                // The colors are currently controlled by CSS.
                ticks.attr("class", (d, i, j) {
                    return (getOpen(d, i) > getClose(d, i) ? "nv-tick negative" : "nv-tick positive") + " nv-tick-" + j + "-" + i;
                });
                var lines = tickGroups.append("line").attr("class", "nv-candlestick-lines").attr("transform", (d, i) {
                    return "translate(" + x(getX(d, i)) + ",0)";
                }).attr("x1", 0).attr("y1", (d, i) {
                    return y(getHigh(d, i));
                }).attr("x2", 0).attr("y2", (d, i) {
                    return y(getLow(d, i));
                });
                var rects = tickGroups.append("rect").attr("class", "nv-candlestick-rects nv-bars").attr("transform", (d, i) {
                    return "translate(" + (x(getX(d, i)) - barWidth / 2) + "," + (y(getY(d, i)) - (getOpen(d, i) > getClose(d, i) ? (y(getClose(d, i)) - y(getOpen(d, i))) : 0)) + ")";
                }).attr("x", 0).attr("y", 0).attr("width", barWidth).attr("height", (d, i) {
                    var open = getOpen(d, i);
                    var close = getClose(d, i);
                    return open > close ? y(close) - y(open) : y(open) - y(close);
                });
                ticks.select(".nv-candlestick-lines").transition().attr("transform", (d, i) {
                    return "translate(" + x(getX(d, i)) + ",0)";
                }).attr("x1", 0).attr("y1", (d, i) {
                    return y(getHigh(d, i));
                }).attr("x2", 0).attr("y2", (d, i) {
                ...
                ticks.select(".nv-candlestick-rects").transition().attr("transform", (d, i) {
                    return "translate(" + (x(getX(d, i)) - barWidth / 2) + "," + (y(getY(d, i)) - (getOpen(d, i) > getClose(d, i) ? (y(getClose(d, i)) - y(getOpen(d, i))) : 0)) + ")";
                }).attr("x", 0).attr("y", 0).attr("width", barWidth).attr("height", (d, i) {
                    var open = getOpen(d, i);
                    var close = getClose(d, i);
        ...
        chart.highlightPoint = (pointIndex, isHoverOver) {
    ...
    nv.models.cumulativeLineChart = () {
        ...
        var stateSetter = (data) {
            return (state) {
                if (!identical(state.index, undefined)) index.i = state.index;
                if (!identical(state.rescaleY, undefined)) rescaleY = state.rescaleY;
                if (!identical(state.active, undefined)) data.forEach((series, i) {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                var availableWidth = nv.utils.availableWidth(width, container, margin),
                    availableHeight = nv.utils.availableHeight(height, container, margin);
                chart.update = () {
                    if (identical(duration, 0)) container.call(chart);
                ...
                if (!defaultState) {
                    ...
                    defaultState = {};
                    for (key in state) {
                        if (state[key] is Array) defaultState[key] = state[key].slice(0);
                ...
                // Display No Data message if there's nothing to show.
                if (!data || !data.length || !data.filter((d) {
                ...
                if (!showLegend) {
                    ...
                    if (!marginTop && !identical(legend.height(), margin.top)) {
                ...
                var tempDisabled = data.filter((d) {
                    return d.tempDisabled;
                });
                wrap.select(".tempDisabled").remove();
                if (tempDisabled.length) {
                    wrap.append("text").attr("class", "tempDisabled").attr("x", availableWidth / 2).attr("y", "-.71em").style("text-anchor", "end").text(tempDisabled.map((d) {
                        return d.key;
                ...
                lines.y((d) {
                    return d.display.y;
                }).width(availableWidth).height(availableHeight).color(data.map((d, i) {
                    return d.color || color(d, i);
                }).filter((d, i) {
                    return !data[i].disabled && !data[i].tempDisabled;
                }));
                var linesWrap = g.select(".nv-linesWrap").datum(data.filter((d) {
                ...
                var avgLineData = data.filter((d) {
                    return !d.disabled && !!average(d);
                });
                var avgLines = g.select(".nv-avgLinesWrap").selectAll("line").data(avgLineData, (d) {
                    return d.key;
                });
                var getAvgLineY = (d) {
                ...
                avgLines.enter().append("line").style("stroke-width", 2).style("stroke-dasharray", "10,10").style("stroke", (d, i) {
                    return lines.color()(d, d.seriesIndex);
                }).attr("x1", 0).attr("x2", availableWidth).attr("y1", getAvgLineY).attr("y2", getAvgLineY);
                avgLines.style("stroke-opacity", (d) {
                ...
                g.select(".nv-background rect").on("click", () {
                ...
                interactiveLayer.dispatch.on("elementMousemove", (e) {
                    ...
                    data.filter((series, i) {
                        ...
                        if (identical(, "undefined")) singlePoint = point;
                        if (identical(, "undefined")) pointXLocation = chart.xScale()(chart.x()(point, pointIndex));
                    ...
                    if (allData.length > 2) {
                        ...
                        if (!identical(indexToHighlight, null)) allData[indexToHighlight].highlight = true;
                    }
                    var xValue = xAxis.tickFormat()(chart.x()(singlePoint, pointIndex), pointIndex);
                    interactiveLayer.tooltip.valueFormatter((d, i) {
        ...
        lines.dispatch.on("elementMouseout.tooltip", (evt) {
            tooltip.hidden(true);
        });
        //============================================================
        ...
        getCurrentYDomain(data) {
            var seriesDomains = data.filter((series) {
                return !(series.disabled || series.tempDisabled);
            }).map((series, i) {
                return d3.extent(series.values, (d) {
                    return d.display.y;
                });
            });
            return [d3.min(seriesDomains, (d) {
                return d[0];
            }), d3.max(seriesDomains, (d) {
                return d[1];
            })];
        }
        //============================================================
    ...
    nv.models.differenceChart = () {
        ...
        var xForMultiChart = xForMultiChart(d) {
            return d.x;
        };
        var xAccessor = xAccessor(d) {
            return d.x;
        };
        var keyForXValue = "x";
        var yAccessor = yAccessor(d) {
            return d.y;
        };
        var duration = 300;
        ...
        chart(selection) {
            selection.each((data) {
                container = d3.select(this);
                var dataWithoutDisabledSeries = (data || []).filter((dataset) {
                ...
                multiChart.interactiveLayer.tooltip.valueFormatter((value, i, datum) {
                    if (identical(datum.key, keyForActualGreaterThanPredicted) || identical(datum.key, keyForActualLessThanPredicted)) {
                ...
                var allValues = processedData.filter((dataset) {
                    return !dataset.disabled;
                }).map((dataset) {
                    return dataset.values;
                });
                var dateExtent = d3.extent(d3.merge(allValues), (d) {
                    return xForMultiChart(d);
                });
                multiChart.xAxis.domain(dateExtent).range([0, availableWidth]);
                var yExtent = d3.extent(d3.merge(allValues), (d) {
                ...
                container.append("g").attr("class", "nv-focusWrap").style("display", "initial").attr("transform", "translate(" + margin.left + ", " + (availableHeight + focus.margin().top) + ")").datum(processedData.filter((dataset) {
                    return identical(dataset.type, "line");
                })).call(focus);
                container.datum(processedData).call(multiChart);
                focus.dispatch.on("onBrush", (extent) {
                    var filteredData = processedData.map((datum) {
                        var leftIndex = -1;
                        var rightIndex = -1;
                        datum.values.some((val, index) {
                            if (identical(leftIndex, -1) && val.x >= extent[0]) {
                                leftIndex = index;
                            }
                            if (identical(rightIndex, -1) && val.x >= extent[1]) {
                                rightIndex = index;
                                return true;
                            }
                            return false;
                        ...
                        return Object.assign({}, datum, values: filteredValues);
                    });
        ...
        chart._options = Object.create({}, width: {
            ...
            "set": set(_) {
                focusMargin.top = !identical(_.top, undefined) ? _.top : focusMargin.top;
                focusMargin.right = !identical(_.right, undefined) ? _.right : focusMargin.right;
                focusMargin.bottom = !identical(_.bottom, undefined) ? _.bottom : focusMargin.bottom;
                focusMargin.left = !identical(_.left, undefined) ? _.left : focusMargin.left;
            }
        }, margin: {
            "get": get() {
                return margin;
        ...
        processData(data) {
            ...
            var allProcessed = clonedData.every((dataset) {
                return dataset.processed;
            });
            var actualData = clonedData.filter((dataSet) {
                return identical(dataSet.type, "actual");
            });
            var predictedData = clonedData.filter((dataSet) {
                return identical(dataSet.type, "expected");
            });
            if (allProcessed) {
                return clonedData;
            ...
            var actualDataAsMap = actualData[0].values.reduce((result, datum, idx) {
                result[xAccessor(datum)] = yAccessor(datum);
                return result;
            }, {});
            var predictedDataAsMap = predictedData[0].values.reduce((result, datum, idx) {
                result[xAccessor(datum)] = yAccessor(datum);
                return result;
            }, {});
            Object.keys(actualDataAsMap).forEach((stringifiedXValue, idx) {
                ...
                // Set actual
                processedData[2].values[idx] = {
                    "x": correctlyFormattedXValue,
                    "y": actualUsage
                };
                // Set predicted
                if (showPredictedLine) {
                    processedData[3].values[idx] = {
                        "x": correctlyFormattedXValue,
                        "y": predictedUsage
                    };
                }
        ...
        isDefined(thingToCheck) {
            // NB: void 0 === undefined
            return !identical(thingToCheck, );
        }
    ...
    nv.models.discreteBar = () {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                x.domain(xDomain || d3.merge(seriesData).map((d) {
                    return d.x;
                })).rangeBands(xRange || [0, availableWidth], .1);
                y.domain(yDomain || d3.extent(d3.merge(seriesData).map((d) {
                    return d.y;
                }).concat(forceY)));
                ...
                var groups = wrap.select(".nv-groups").selectAll(".nv-group").data((d) {
                    return d;
                }, (d) {
                    return d.key;
                });
                ...
                var bars = groups.selectAll("g.nv-bar").data((d) {
                    return d.values;
                });
                bars.exit().remove();
                var barsEnter = bars.enter().append("g").attr("transform", (d, i, j) {
                    return "translate(" + (x(getX(d, i)) + x.rangeBand() * .05) + ", " + y(0) + ")";
                }).on("mouseover", (d, i) {
                    d3.select(this).classed("hover", true);
                    dispatch.elementMouseover(data: d, index: i, color: d3.select(this).style("fill"));
                }).on("mouseout", (d, i) {
                    d3.select(this).classed("hover", false);
                    dispatch.elementMouseout(data: d, index: i, color: d3.select(this).style("fill"));
                }).on("mousemove", (d, i) {
                    dispatch.elementMousemove(data: d, index: i, color: d3.select(this).style("fill"));
                }).on("click", (d, i) {
                    var element = this;
                    dispatch.elementClick(data: d, index: i, color: d3.select(this).style("fill"), event: d3.event, element: element);
                    d3.event.stopPropagation();
                }).on("dblclick", (d, i) {
                    dispatch.elementDblClick(data: d, index: i, color: d3.select(this).style("fill"));
                    d3.event.stopPropagation();
                });
                ...
                if (showValues) {
                    ...
                    }).watchTransition(renderWatch, "discreteBar: bars text").attr("x", x.rangeBand() * .9 / 2).attr("y", (d, i) {
                ...
                bars.attr("class", (d, i) {
                    ...
                    return d.color || color(d, i);
                }).select("rect").attr("rx", cornerRadius).attr("class", rectClass).watchTransition(renderWatch, "discreteBar: bars rect").attr("width", x.rangeBand() * .9 / data.length);
    ...
    nv.models.discreteBarChart = () {
        ...
        yAxis.orient((rightAlignYAxis) ? "right" : "left").tickFormat(d3.format(",.1f"));
        tooltip.duration(0).headerEnabled(false).valueFormatter((d, i) {
            return yAxis.tickFormat()(d, i);
        }).keyFormatter((d, i) {
            return xAxis.tickFormat()(d, i);
        });
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                if (showYAxis) {
                    yAxis.scale(y)._ticks(nv.utils.calcTicksY(availableHeight / 36, data, discretebar.y())).tickSize(-availableWidth, 0);
                    g.select(".nv-y.nv-axis").call(yAxis);
                }
                // Zero line
        ...
        //------------------------------------------------------------
        discretebar.dispatch.on("elementMouseover.tooltip", (evt) {
            evt["series"] = {
        ...
        discretebar.dispatch.on("elementMouseout.tooltip", (evt) {
            tooltip.hidden(true);
        });
        discretebar.dispatch.on("elementMousemove.tooltip", (evt) {
            tooltip();
        });
        //============================================================
    ...
    nv.models.distribution = () {
        ...
        chart(selection) {
            renderWatch.reset();
            selection.each((data) {
                var availableLength = width - (identical(axis, "x") ? margin.left + margin.right : margin.top + margin.bottom),
                    naxis = axis == "x" ? "y" : "x",
                    container = d3.select(this);
                nv.utils.initSVG(container);
                //------------------------------------------------------------
                ...
                wrap.attr("transform", "translate(" + margin.left + "," + margin.top + ")");
                //------------------------------------------------------------
                var distWrap = g.selectAll("g.nv-dist").data((d) {
                    return d;
                }, (d) {
                    return d.key;
                });
                distWrap.enter().append("g");
                distWrap.attr("class", (d, i) {
                    return "nv-dist nv-series-" + i;
                }).style("stroke", (d, i) {
                    return color(d, i);
                });
                var dist = distWrap.selectAll("line.nv-dist" + axis).data((d) {
                    return d.values;
                });
                dist.enter().append("line").attr(axis + "1", (d, i) {
                    return scale0(getData(d, i));
                }).attr(axis + "2", (d, i) {
                    return scale0(getData(d, i));
                });
                renderWatch.transition(distWrap.exit().selectAll("line.nv-dist" + axis), "dist exit").attr(axis + "1", (d, i) {
                ...
                renderWatch.transition(dist, "dist").attr(axis + "1", (d, i) {
                    return scale(getData(d, i));
                }).attr(axis + "2", (d, i) {
                    return scale(getData(d, i));
                });
        ...
        chart.margin = (_) {
            if (!arguments.length) return margin;
            margin.top = != "undefined" ? _.top : margin.top;
            margin.right = != "undefined" ? _.right : margin.right;
            margin.bottom = != "undefined" ? _.bottom : margin.bottom;
            margin.left = != "undefined" ? _.left : margin.left;
            return chart;
        };
        chart.width = (_) {
    ...
    nv.models.distroPlot = () {
        ...
        var margin = {
            ...
            getValsArr = (d) {
                return d.values.observations.map((e) {
                    return e.y;
                });
            },
            plotType, observationType = false,
            whiskerDef = "iqr",
            hideWhiskers = false,
            notchBox = false,
            colorGroup = false,
        ...
        select_sigma(x) {
            ...
            var normalize = 1.349;
            var IQR = (d3.quantile(sorted, 0.75) - d3.quantile(sorted, 0.25)) / normalize;
        ...
        /*
           ...
           Scott, D.W. (1992) Multivariate Density Estimation: Theory, Practice, and
               Visualization.
            */
        calcBandwidth(x, type) {
            if (identical(, "undefined")) type = "scott";
            // TODO: consider using https://github.com/jasondavies/science.js
            var A = select_sigma(x);
            var n = x.length;
            return identical(type, "scott") ? Math.pow(1.059 * A * n, -0.2) : Math.pow(.9 * A * n, -0.2);
        }
        /*
        ...
        prepData(dat) {
            ...
            calcStats(g, xGroup) {
                 ...
                 */
                var wl = {
                    "iqr": d3.max([d3.min(v), d3.min(v.filter((d) {
                        return d > lower;
                    }))]),
                    "minmax": d3.min(v),
                ...
                var wu = {
                    "iqr": d3.min([d3.max(v), d3.max(v.filter((d) {
                        return d < upper;
                    }))]),
                    "minmax": d3.max(v),
                    "stddev": d3.mean(v) + d3.deviation(v)
                ...
                if (!identical(, "undefined")) {
                    observations = d3.beeswarm().data(g.map((e) {
                        return getY(e);
                    })).radius(pointSize + 1).orientation("vertical").side("symmetric").distributeOn((e) {
                        return yScale(e);
                    }).arrange();
                    ...
                    observations.map((e, i) {
                        ...
                        e.randX = Math.random() * jitter * (Math.floor(Math.random() * 2) == 1 ? 1 : -1);
                    });
                } else {
                    v.forEach((e, i) {
                        observations.push(object_constancy: e.object_constancy, datum: e, key: xGroup, isOutlier: (e < wl.iqr || e > wu.iqr), isOutlierStdDev: (e < wl.stddev || e > wu.stddev), randX: Math.random() * jitter * (Math.floor(Math.random() * 2) == 1 ? 1 : -1));
                    });
                }
                ...
                var tmpScale = d3.scale.linear().domain([0, d3.max(kdeDat, (e) {
                    return e.y;
                })]).clamp(true);
                yVScale.push(tmpScale);
                var reformat = {
                    "count": v.length,
                    "num_outlier": observations.filter((e) {
                        return e.isOutlier;
                    }).length,
                    "sum": d3.sum(v),
                    "mean": mean,
        ...
        clampViolinKDE(kde, extent) {
            ...
            if (identical(extent[0], extent[1])) return kde;
            var clamped = kde.reduce((res, d) {
         ...
         * 
         */
        makeNotchBox(boxLeft, notchLeft, boxCenter, dat) {
            var boxPoints;
         ...
         */
        getAvailableColorGroups(x) {
            if (!colorGroup) return x;
            var tmp = reformatDat.find((d) {
                return d.key == x;
            });
            return tmp.values.map((d) {
                return d.key;
            }).sort(d3.ascending);
        }
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                yScale.domain(yDomain || d3.extent(data.map((d) {
                    return getY(d);
                }))).nice().range(yRange || [availableHeight, 0]);
                if (identical(, "undefined")) reformatDat = prepData(data);
                // Setup x-scale
                xScale.rangeBands(xRange || [0, availableWidth], 0.1).domain(xDomain || (colorGroup && !squash) ? allColorGroups : reformatDat.map((d) {
                    return d.key;
                }));
                // Setup containers and skeleton of chart
                ...
                var areaEnter, distroplots = wrap.selectAll(".nv-distroplot-x-group").data((d) {
                    return d;
                });
                // rebind new data
                ...
                distroplots.each((d, i) {
                    d3.select(this).selectAll("line.nv-distroplot-middle").datum(d);
                });
                areaEnter = distroplots.enter().append("g").attr("class", "nv-distroplot-x-group").style("stroke-opacity", 1e-6).style("fill-opacity", 1e-6).style("fill", (d, i) {
                    return getColor(d) || color(d, i);
                }).style("stroke", (d, i) {
                    return getColor(d) || color(d, i);
                });
                ...
                areaEnter.attr("transform", (d) {
                    return "translate(" + (xScale(d.key) + (rangeBand() - areaWidth()) * 0.5) + ", 0)";
                });
                distroplots.watchTransition(renderWatch, "nv-distroplot-x-group: distroplots").style("stroke-opacity", 1).style("fill-opacity", 0.5).attr("transform", (d) {
                    return "translate(" + (xScale(d.key) + (rangeBand() - areaWidth()) * 0.5) + ", 0)";
                });
                ...
                [getWl, getWh].forEach((f) {
                    var key = (identical(f, getWl)) ? "low" : "high";
                    var endpoint = (identical(f, getWl)) ? getQ1 : getQ3;
                    distroplots.select("line.nv-distroplot-whisker.nv-distroplot-" + key).watchTransition(renderWatch, "nv-distroplot-x-group: distroplots").attr("x1", areaCenter()).attr("y1", (d) {
                        return plotType != "violin" ? yScale(f(d)) : yScale(getQ2(d));
                    }).attr("x2", areaCenter()).attr("y2", (d) {
                        return plotType == "box" ? yScale(endpoint(d)) : yScale(getQ2(d));
                    }).style("opacity", () {
                        return hideWhiskers ? "0" : "1";
                    });
                    distroplots.select("line.nv-distroplot-tick.nv-distroplot-" + key).watchTransition(renderWatch, "nv-distroplot-x-group: distroplots").attr("x1", (d) {
                ...
                [getWl, getWh].forEach((f) {
                    var key = (identical(f, getWl)) ? "low" : "high";
                    areaEnter.selectAll(".nv-distroplot-" + key).on("mouseover", (d, i, j) {
                        d3.select(this.parentNode).selectAll("line.nv-distroplot-" + key).classed("hover", true);
                        dispatch.elementMouseover(value: key == "low" ? "Lower whisker" : "Upper whisker", series: {
                            "key": f(d).toFixed(2),
                            "color": getColor(d) || color(d, j)
                        }, e: d3.event);
                    }).on("mouseout", (d, i, j) {
                        d3.select(this.parentNode).selectAll("line.nv-distroplot-" + key).classed("hover", false);
                        dispatch.elementMouseout(value: key == "low" ? "Lower whisker" : "Upper whisker", series: {
                            "key": f(d).toFixed(2),
                            "color": getColor(d) || color(d, j)
                        }, e: d3.event);
                    }).on("mousemove", (d, i) {
                ...
                areaEnter.each((d, i) {
                    ...
                    ["left", "right"].forEach((side) {
                        ["line", "area"].forEach((d) {
                            violin.append("path").attr("class", "nv-distribution-" + d + " nv-distribution-" + side).attr("transform", "rotate(90,0,0)   translate(0," + (side == "left" ? -areaWidth() : 0) + ")" + (side == "left" ? "" : " scale(1,-1)"));
                        });
                    });
                    areaEnter.selectAll(".nv-distribution-line").style("fill", "none");
                    areaEnter.selectAll(".nv-distribution-area").style("stroke", "none").style("opacity", 0.7);
                });
                // transitions
                distroplots.each((d, i) {
                    var violin = d3.select(this);
                    ...
                    if (plotType == "box" || plotType == "violin") {
                        ["left", "right"].forEach((side) {
                            // line
                            distroplots.selectAll(".nv-distribution-line.nv-distribution-" + side).attr("d", d3.svg.line().x((e) {
                                return plotType == "box" ? e.y : yScale(e.x);
                            }).y((e) {
                                return plotType == "box" ? e.x : tmpScale(e.y);
                            }).interpolate(interp)).attr("transform", "rotate(90,0,0)   translate(0," + (side == "left" ? -areaWidth() : 0) + ")" + (side == "left" ? "" : " scale(1,-1)")).style("opacity", !plotType ? "0" : "1");
                            // area
                            distroplots.selectAll(".nv-distribution-area.nv-distribution-" + side).attr("d", d3.svg.area().x((e) {
                                return plotType == "box" ? e.y : yScale(e.x);
                            }).y((e) {
                                return plotType == "box" ? e.x : tmpScale(e.y);
                            }).y0(areaWidth() / 2).interpolate(interp)).attr("transform", "rotate(90,0,0)   translate(0," + (side == "left" ? -areaWidth() : 0) + ")" + (side == "left" ? "" : " scale(1,-1)")).style("opacity", !plotType ? "0" : "1");
                        });
                    } else {
                        distroplots.selectAll(".nv-distribution-area").watchTransition(renderWatch, "nv-distribution-area: distroplots").style("opacity", !plotType ? "0" : "1");
                        distroplots.selectAll(".nv-distribution-line").watchTransition(renderWatch, "nv-distribution-line: distroplots").style("opacity", !plotType ? "0" : "1");
                    }
                });
                // tooltip events
                distroplots.selectAll("path").on("mouseover", (d, i, j) {
                    d = d3.select(this.parentNode).datum();
                    d3.select(this).classed("hover", true);
                    dispatch.elementMouseover(key: d.key, value: "Group " + d.key + " stats", series: [{
                        "key": "max",
                    ...
                    d3.select(this).classed("hover", false);
                    d = d3.select(this.parentNode).datum();
                    dispatch.elementMouseout(key: d.key, value: "Group " + d.key + " stats", series: [{
                        "key": "max",
                        "value": getMax(d).toFixed(2),
                        "color": getColor(d) || color(d, j)
                    }, {
                ...
                // median/mean line
                areaEnter.append("line").attr("class", (d) {
                    return "nv-distroplot-middle";
                });
                distroplots.selectAll("line.nv-distroplot-middle").watchTransition(renderWatch, "nv-distroplot-x-group: distroplots line").attr("x1", notchBox ? tickLeft : plotType != "violin" ? areaLeft : tickLeft()).attr("y1", (d, i, j) {
                    return centralTendency == "mean" ? yScale(getMean(d)) : yScale(getQ2(d));
                }).attr("x2", notchBox ? tickRight : plotType != "violin" ? areaRight : tickRight()).attr("y2", (d, i) {
                    return centralTendency == "mean" ? yScale(getMean(d)) : yScale(getQ2(d));
                }).style("opacity", centralTendency ? "1" : "0");
                // tooltip
                distroplots.selectAll(".nv-distroplot-middle").on("mouseover", (d, i, j) {
                    if (d3.select(this).style("opacity") == 0) return;
                    var fillColor = d3.select(this.parentNode).style("fill");
                    d3.select(this).classed("hover", true);
                    dispatch.elementMouseover(value: centralTendency == "mean" ? "Mean" : "Median", series: {
                    ...
                    d3.select(this).classed("hover", false);
                    var fillColor = d3.select(this.parentNode).style("fill");
                    dispatch.elementMouseout(value: centralTendency == "mean" ? "Mean" : "Median", series: {
                        "key": centralTendency == "mean" ? getMean(d).toFixed(2) : getQ2(d).toFixed(2),
                        "color": fillColor
                    }, e: d3.event);
                }).on("mousemove", (d, i) {
                ...
                var obsWrap = distroplots.selectAll("g.nv-distroplot-observation").data((d) {
                    return getValsObj(d);
                }, (d) {
                    return d.object_constancy;
                });
                var obsGroup = obsWrap.enter().append("g").attr("class", "nv-distroplot-observation");
                ...
                if (observationType == "line") {
                    distroplots.selectAll("g.nv-distroplot-observation line").watchTransition(renderWatch, "nv-distrolot-x-group: nv-distoplot-observation").attr("x1", tickLeft() + areaWidth() / 4).attr("x2", tickRight() - areaWidth() / 4).attr("y1", (d) {
                        return yScale(d.datum);
                    }).attr("y2", (d) {
                        return yScale(d.datum);
                    });
                } else {
                    distroplots.selectAll("g.nv-distroplot-observation circle").watchTransition(renderWatch, "nv-distroplot: nv-distroplot-observation").attr("cy", (d) {
                        return yScale(d.datum);
                    }).attr("r", pointSize);
                    ...
                    distroplots.selectAll("g.nv-distroplot-observation circle").watchTransition(renderWatch, "nv-distroplot: nv-distroplot-observation").attr("cx", (d) {
                ...
                if (!identical(observationType, false)) {
                    if (!showOnlyOutliers) {
                        distroplots.selectAll(observationType == "line" ? "line" : "circle").watchTransition(renderWatch, "nv-distroplot: nv-distroplot-observation").style("opacity", 1);
                    } else {
                        distroplots.selectAll(".nv-distroplot-outlier " + (observationType == "line" ? "line" : "circle")).watchTransition(renderWatch, "nv-distroplot: nv-distroplot-observation").style("opacity", 1);
                        distroplots.selectAll(".nv-distroplot-non-outlier " + (observationType == "line" ? "line" : "circle")).watchTransition(renderWatch, "nv-distroplot: nv-distroplot-observation").style("opacity", 0);
                    }
                }
                ...
                distroplots.selectAll(".nv-distroplot-observation").on("mouseover", (d, i, j) {
                    var pt = d3.select(this);
                    if (showOnlyOutliers && plotType == "box" && !isOutlier(d)) return;
                    var fillColor = d3.select(this.parentNode).style("fill");
                    pt.classed("hover", true);
                    dispatch.elementMouseover(value: (plotType == "box" && isOutlier(d)) ? "Outlier" : "Observation", series: {
                    ...
                    dispatch.elementMouseout(value: (plotType == "box" && isOutlier(d)) ? "Outlier" : "Observation", series: {
                        "key": d.datum.toFixed(2),
                        "color": fillColor
                    }, e: d3.event);
                }).on("mousemove", (d, i) {
    ...
    nv.models.distroPlotChart = () {
        ...
        arraysEqual(arr1, arr2) {
            if (!identical(arr1.length, arr2.length)) return false;
        ...
        objectEquals(a, b) {
            ...
            for (var i = 0; i < aProps.length; i++) {
                ...
                // objects are not equivalent
                if (!identical(a[propName], b[propName])) {
                    return false;
                }
            }
            return true;
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                chart.update = () {
                    ...
                    if (!identical(colorGroup0, opts.colorGroup()) || !identical(x0, opts.x()) || !identical(y0, opts.y()) || !identical(bandwidth0, opts.bandwidth()) || !identical(resolution0, opts.resolution()) || !identical(clampViolin0, opts.clampViolin()) || dataHasChanged(data)) {
                        distroplot.recalcData();
                    }
                    container.transition().duration(duration).call(chart);
                };
                chart.container = this;
                if (!identical(, "function") && chart.options().observationType() == "swarm") {
                ...
                defsEnter.append("clipPath").attr("id", "nv-x-label-clip-" + distroplot.id()).append("rect");
        ...
        //------------------------------------------------------------
        distroplot.dispatch.on("elementMouseover.tooltip", (evt) {
            tooltip.data(evt).hidden(false);
        });
        distroplot.dispatch.on("elementMouseout.tooltip", (evt) {
            tooltip.data(evt).hidden(true);
        });
        distroplot.dispatch.on("elementMousemove.tooltip", (evt) {
            tooltip();
        });
        //============================================================
    ...
    nv.models.focus = (content) {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                g.select(".nv-background rect").attr("width", availableWidth).attr("height", availableHeight);
                content.width(availableWidth).height(availableHeight).color(data.map((d, i) {
                    return d.color || color(d, i);
                }).filter((d, i) {
                    return !data[i].disabled;
                }));
                var contentWrap = g.select(".nv-contentWrap").datum(data.filter((d) {
                    return !d.disabled;
                }));
                ...
                updateBrushBG() {
                    ...
                    brushBG.data([brush.empty() ? x.domain() : brushExtent]).each((d, i) {
    ...
    nv.models.forceDirectedGraph = () {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                var link = container.selectAll(".link").data(data.links).enter().append("line").attr("class", "nv-force-link").style("stroke-width", (d) {
                    return Math.sqrt(d.value);
                });
                var node = container.selectAll(".node").data(data.nodes).enter().append("g").attr("class", "nv-force-node").call(force.drag);
                node.append("circle").attr("r", radius).style("fill", (d) {
                    return color(d);
                }).on("mouseover", (evt) {
                    ...
                    evt.series = [];
                    nodeFieldSet.forEach((field) {
                        evt.series.push(color: nodeColor, key: field, value: evt[field]);
                    });
                    tooltip.data(evt).hidden(false);
                }).on("mouseout", (d) {
                    tooltip.hidden(true);
    ...
    nv.models.furiousLegend = () {
        ...
        chart(selection) {
            selection.each((data) {
                ...
                var g = wrap.select("g");
                wrap.attr("transform", "translate(" + margin.left + "," + margin.top + ")");
                var series = g.selectAll(".nv-series").data((d) {
                    ...
                    if (updateState) {
                        if (vers == "classic") {
                            ...
                            if (expanded) {
                                ...
                                var engaged = data.filter((d) {
                                    return !d.disengaged;
                                });
                                if (engaged.every((series) {
                        ...
                        dispatch.stateChange(disabled: data.map((d) {
                            return !!d.disabled;
                        }), disengaged: data.map((d) {
                            return !!d.disengaged;
                        }));
                    }
                }).on("dblclick", (d, i) {
                ...
                series.classed("nv-disabled", (d) {
                    return d.userDisabled;
                });
                series.exit().remove();
                seriesText.attr("fill", setTextColor).text((d) {
                ...
                if (align) {
                    ...
                    if (identical(seriesPerRow, 0)) seriesPerRow = 1;
                ...
                if (vers == "furious") {
                    ...
                    seriesShape.attr("width", (d, i) {
                        return seriesText[0][i].getComputedTextLength() + 27;
                    }).attr("height", 18).attr("y", -9).attr("x", -15);
                }
                seriesShape.style("fill", setBGColor).style("stroke", (d, i) {
                    return d.color || color(d, i);
                });
            });
            setTextColor(d, i) {
...
*/
    nv.models.heatMap = () {
        ...
        var margin = {
            ...
            showCellValues = true,
            cellValueFormat = (d) {
                return identical(, "number") ? d.toFixed(0) : d;
            },
        ...
        cellColor(d) {
            ...
            return (cellsAreNumeric() && !isNaN(colorVal) || !identical(, "undefined")) ? colorScale(colorVal) : missingDataColor;
        }
        ...
        getColorDomain() {
            if (cellsAreNumeric()) {
                return normalize ? d3.extent(prepedData, (d) {
                    return getNorm(d);
        ...
        prepData(data) {
            ...
            data.forEach((cell) {
                ...
                if (!()) {
                    ...
                    ix++;
                    sortedCells[valX] = {};
                    if (identical(, "function")) uniqueXMeta.push(xMeta(cell));
                }
                if (!()) {
                    uniqueY[valY] = iy;
                    iy++;
                    sortedCells[valX][valY] = {};
                    if (identical(, "function")) uniqueYMeta.push(yMeta(cell));
                }
            ...
            // and top to bottom
            var reformatData = [];
            Object.keys(uniqueY).forEach((j) {
                Object.keys(uniqueX).forEach((i) {
        ...
        isArrayInArray(arr, item) {
            ...
            var contains = arr.some((ele) {
                return identical(JSON.stringify(ele), item_as_string);
            });
            return contains;
        }
        ...
        var cellValueLabel = (d) {
            var val = !normalize ? cellValueFormat(getCellValue(d)) : cellValueFormat(getNorm(d));
            return (cellsAreNumeric() && !isNaN(val) || !identical(, "undefined")) ? val : missingDataLabel;
        };
        ...
        getKeyByValue(object, value) {
            ...
            return Object.keys(object).filter((key) {
                return identical(object[key], value);
            })[0];
        }
        //============================================================
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                nv.utils.initSVG(container);
                // Setup Scales
                xScale.domain(xDomain || sortObjByVals(uniqueX)).rangeBands(xRange || [0, availableWidth - cellBorderWidth / 2]);
                ...
                colorScale.domain(colorDomain || getColorDomain()).range(colorRange || RdYlBu);
                // Setup containers and skeleton of chart
                ...
                wrap.watchTransition(renderWatch, "nv-wrap: heatMapWrap").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
                var gridWrap = wrapEnter.append("g").attr("class", "cellGrid").style("opacity", 1e-6);
                var gridLinesV = wrap.select(".cellGrid").selectAll(".gridLines.verticalGrid").data(Object.values(uniqueX).concat([Object.values(uniqueX).length]));
                gridLinesV.enter().append("line").attr("class", "gridLines verticalGrid");
                ...
                gridLinesH.enter().append("line").attr("class", "gridLines horizontalGrid");
                gridLinesH.exit().remove();
                var cellWrap = wrap.select(".cellWrap").selectAll(".nv-cell").data((d) {
                    return d;
                }, (e) {
                    return getIdx(e);
                });
                var xMetaWrap = wrapEnter.append("g").attr("class", "xMetaWrap").attr("transform", () {
                    return "translate(0," + (-xMetaHeight() - cellBorderWidth - metaOffset) + ")";
                });
                var xMetas = wrap.select(".xMetaWrap").selectAll(".x-meta").data(uniqueXMeta);
                var xMetaEnter = xMetas.enter().append("rect").attr("class", "x-meta meta").attr("width", cellWidth - cellBorderWidth).attr("height", xMetaHeight()).attr("transform", "translate(0,0)").attr("fill", (d) {
                    return xMetaColorScale(d);
                });
                var yMetaWrap = wrapEnter.append("g").attr("class", "yMetaWrap").attr("transform", (d, i) {
                    return "translate(" + (-yMetaWidth() - cellBorderWidth - metaOffset) + ",0)";
                });
                var yMetas = wrap.select(".yMetaWrap").selectAll(".y-meta").data(uniqueYMeta);
                var yMetaEnter = yMetas.enter().append("rect").attr("class", "y-meta meta").attr("width", yMetaWidth()).attr("height", cellHeight - cellBorderWidth).attr("transform", (d, i) {
                ...
                yMetas.exit().remove();
                // CELLS    
                var cellsEnter = cellWrap.enter().append("g").style("opacity", 1e-6).attr("transform", (d) {
                ...
                cellsEnter.append("text").attr("text-anchor", "middle").attr("dy", 4).attr("class", "cell-text");
                // transition cell (rect) size
                cellWrap.selectAll("rect").watchTransition(renderWatch, "heatMap: rect").attr("width", cellWidth - cellBorderWidth).attr("height", cellHeight - cellBorderWidth).attr("rx", cellRadius).attr("ry", cellRadius).style("stroke", (d) {
                    return cellColor(d);
                });
                // transition cell (g) position, opacity and fill
                cellWrap.attr("class", (d) {
                ...
                cellWrap.selectAll("text").watchTransition(renderWatch, "heatMap: cells text").text((d) {
                ...
                // transition grid
                wrap.selectAll(".verticalGrid").watchTransition(renderWatch, "heatMap: gridLines").attr("y1", 0).attr("y2", availableHeight - cellBorderWidth).attr("x1", (d) {
                    return d * cellWidth - cellBorderWidth / 2;
                }).attr("x2", (d) {
                    return d * cellWidth - cellBorderWidth / 2;
                });
                var numHLines = Object.keys(uniqueY).length;
                wrap.selectAll(".horizontalGrid").watchTransition(renderWatch, "heatMap: gridLines").attr("x1", (d) {
                ...
                xMetas.watchTransition(renderWatch, "heatMap: xMetaRect").attr("width", cellWidth - cellBorderWidth).attr("height", xMetaHeight()).attr("transform", (d, i) {
                    return "translate(" + (i * cellWidth) + ",0)";
                });
                yMetas.watchTransition(renderWatch, "heatMap: yMetaRect").attr("width", yMetaWidth()).attr("height", cellHeight - cellBorderWidth).attr("transform", (d, i) {
                    return "translate(0," + (i * cellHeight) + ")";
                });
                // transition position of meta wrap g & opacity
                wrap.select(".xMetaWrap").watchTransition(renderWatch, "heatMap: xMetaWrap").attr("transform", (d, i) {
                    return "translate(0," + (-xMetaHeight() - cellBorderWidth - metaOffset) + ")";
                }).style("opacity", () {
                    return !identical(xMeta, false) ? 1 : 0;
                });
                wrap.select(".yMetaWrap").watchTransition(renderWatch, "heatMap: yMetaWrap").attr("transform", (d, i) {
                    return "translate(" + (-yMetaWidth() - cellBorderWidth - metaOffset) + ",0)";
                }).style("opacity", () {
                    return !identical(yMeta, false) ? 1 : 0;
                });
                // TOOLTIPS
                cellWrap.on("mouseover", (d, i) {
                    var idx = getIdx(d);
                    var ix = getIX(d);
                    var iy = getIY(d);
                    ...
                    dispatch.elementMouseover(value: getKeyByValue(uniqueX, ix) + " & " + getKeyByValue(uniqueY, iy), series: {
                ...
                allMetaRect.on("mouseover", (d, i) {
                    ...
                    d3.select(this).classed("cell-hover", true);
                    d3.select(this).classed("no-hover", false);
                    dispatch.elementMouseover(value: isColMeta ? "Column meta" : "Row meta", series: {
                        "value": d,
                    ...
                    var x = coordinates[0];
                    var y = coordinates[1];
                    if (y < 0 || x < 0 || (isColMeta && x + cellBorderWidth >= availableWidth) || (!isColMeta && y + cellBorderWidth >= availableHeight)) {
                        // remove all hover classes
                        removeAllHoverClasses();
                        dispatch.elementMouseout(e: d3.event);
                    }
...
*/
    nv.models.heatMapChart = () {
        ...
        var margin = {
            ...
            dispatch = d3.dispatch("beforeUpdate", "renderEnd"),
            duration = 250;
        xAxis.orient(alignXAxis).showMaxMin(false).tickFormat((d) {
            return d;
        });
        yAxis.orient(alignYAxis).showMaxMin(false).tickFormat((d) {
            return d;
        });
        tooltip.duration(0).headerEnabled(true).keyFormatter((d, i) {
            return xAxis.tickFormat()(d, i);
        });
        //============================================================
        ...
        // of color bin
        quantizeLegendValues() {
            var e = heatMap.colorScale(),
                legendVals;
            if (identical(, "string")) {
                legendVals = e.domain();
            } else {
                legendVals = e.range().map((color) {
                    var d = e.invertExtent(color);
                    if (identical(d[0], null)) d[0] = e.domain()[0];
                    if (identical(d[1], null)) d[1] = e.domain()[1];
                    return d;
                });
            }
            return legendVals;
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                var heatMapWrap = g.select(".nv-heatMap").datum(data.filter((d) {
                    return !d.disabled;
                }));
                ...
                axisX.call(xAxis).watchTransition(renderWatch, "heatMap: axisX").selectAll(".tick").style("opacity", () {
                    return showXAxis ? 1 : 0;
                });
                var xTicks = axisX.selectAll("g");
                xTicks.selectAll(".tick text").attr("transform", (d, i, j) {
                ...
                if (alignXAxis == "bottom") {
                    axisX.watchTransition(renderWatch, "heatMap: axisX").attr("transform", "translate(0," + (availableHeight - yPos) + ")");
                    if (!identical(heatMap.xMeta(), false)) {
                        var pos = availableHeight + heatMap.metaOffset() + heatMap.cellBorderWidth();
                        g.select(".xMetaWrap").watchTransition(renderWatch, "heatMap: xMetaWrap").attr("transform", (d, i) {
                            return "translate(0," + pos + ")";
                        });
                    }
                } else {
                    axisX.watchTransition(renderWatch, "heatMap: axisX").attr("transform", "translate(0," + yPos + ")");
                }
                yAxis.scale(y)._ticks(nv.utils.calcTicksY(availableHeight / 36, data)).tickSize(-availableWidth, 0);
                var axisY = g.select(".nv-y.nv-axis");
                axisY.call(yAxis).watchTransition(renderWatch, "heatMap: axisY").selectAll(".tick").style("opacity", () {
                ...
                if (alignYAxis == "right") {
                    ...
                    if (!identical(heatMap.yMeta(), false)) {
                        var pos = availableWidth + heatMap.metaOffset() + heatMap.cellBorderWidth();
                        g.select(".yMetaWrap").watchTransition(renderWatch, "heatMap: yMetaWrap").attr("transform", (d, i) {
                ...
                var legendVal = quantizeLegendValues().map((d) {
                    if (Array.isArray(d)) {
                        return {
                ...
                legendWrap.datum(legendVal).call(legend).attr("transform", "translate(0," + (alignXAxis == "top" ? availableHeight : -30) + ")");
                legendWrap.watchTransition(renderWatch, "heatMap: nv-legendWrap").style("opacity", () {
        ...
        //------------------------------------------------------------
        heatMap.dispatch.on("elementMouseover.tooltip", (evt) {
            tooltip.data(evt).hidden(false);
        });
        heatMap.dispatch.on("elementMouseout.tooltip", (evt) {
            tooltip.hidden(true);
        });
        heatMap.dispatch.on("elementMousemove.tooltip", (evt) {
            tooltip();
        });
        //============================================================
    ...
    nv.models.historicalBar = () {
        ...
        chart(selection) {
            selection.each((data) {
                ...
                wrap.select("#nv-chart-clip-path-" + id + " rect").attr("width", availableWidth).attr("height", availableHeight);
                g.attr("clip-path", clipEdge ? "url(#nv-chart-clip-path-" + id + ")" : "");
                var bars = wrap.select(".nv-bars").selectAll(".nv-bar").data((d) {
                    return d;
                }, (d, i) {
                    return getX(d, i);
                });
                bars.exit().remove();
                bars.enter().append("rect").attr("x", 0).attr("y", (d, i) {
                ...
                }).watchTransition(renderWatch, "bars").attr("transform", (d, i) {
                    return "translate(" + (x(getX(d, i)) - availableWidth / data[0].values.length * .45) + ",0)";
                }).attr("width", (availableWidth / data[0].values.length) * .9);
                bars.watchTransition(renderWatch, "bars").attr("y", (d, i) {
    ...
    nv.models.historicalBarChart = (bar_model) {
        "use strict";
        //============================================================
        ...
        chart(selection) {
            selection.each((data) {
                ...
                bars.width(availableWidth).height(availableHeight).color(data.map((d, i) {
                    return d.color || color(d, i);
                }).filter((d, i) {
                    return !data[i].disabled;
                }));
                ...
                interactiveLayer.dispatch.on("elementMousemove", (e) {
                    ...
                    data.filter((series, i) {
                        ...
                        var point = series.values[pointIndex];
                        if (identical(point, undefined)) return;
                        if (identical(singlePoint, undefined)) singlePoint = point;
                        if (identical(pointXLocation, undefined)) pointXLocation = chart.xScale()(chart.x()(point, pointIndex));
                        allData.push(key: series.key, value: chart.y()(point, pointIndex), color: color(series, series.seriesIndex), data: series.values[pointIndex]);
                    });
                ...
                legend.dispatch.on("legendDblclick", (d) {
        ...
        //------------------------------------------------------------
        bars.dispatch.on("elementMouseover.tooltip", (evt) {
            evt["series"] = {
                "key": chart.x()(evt.data),
                "value": chart.y()(evt.data),
                "color": evt.color
        ...
        bars.dispatch.on("elementMouseout.tooltip", (evt) {
            tooltip.hidden(true);
        });
        bars.dispatch.on("elementMousemove.tooltip", (evt) {
            tooltip();
        });
        //============================================================
    ...
    nv.models.legend = () {
        ...
        chart(selection) {
            selection.each((data) {
                ...
                var gEnter = wrap.enter().append("g").attr("class", "nvd3 nv-legend").append("g");
                var g = wrap.select("g");
                if (rightAlign) wrap.attr("transform", "translate(" + (-margin.right) + "," + margin.top + ")");
    ...
    nv.models.line = () {
        ...
        var margin = {
            ...
            defined = (d, i) {
                return !isNaN(getY(d, i)) && !identical(getY(d, i), null);
            },
            isArea = (d) {
                return d.area;
            },
            clipEdge = false,
            x, y, interpolate = "linear",
            curve = d3.curveBasis,
            duration = 250,
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                var wrapEnter = wrap.enter().append("g").attr("class", "nvd3 nv-wrap nv-line").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
                var defsEnter = wrapEnter.append("defs");
                var gEnter = wrapEnter.append("g");
                ...
                defsEnter.merge(defsEnter).append("clipPath").attr("id", "nv-edge-clip-" + scatter.id()).append("rect").attr("width", availableWidth).attr("height", (availableHeight > 0) ? availableHeight : 0);
                ...
                var groups = nvGroups.selectAll(".nv-group").data((d) {
                    return d;
                }, (d) {
                    return d.key;
                });
                var groupsEntries = groups.enter().append("g").style("stroke-opacity", 1e-6).style("stroke-width", (d) {
                    return d.strokeWidth || strokeWidth;
                }).style("fill-opacity", 1e-6);
                groups.exit().remove();
                groupsEntries.attr("class", (d, i) {
                ...
                groupsEntries.watchTransition(renderWatch, "line: groups").style("stroke-opacity", 1).style("fill-opacity", (d) {
                    return d.fillOpacity || .5;
                });
                var areaPaths = groups.selectAll("path.nv-area").data((d) {
                    return isArea(d) ? [d] : [];
                });
                areaPaths.enter().append("path").attr("class", "nv-area").attr("d", (d) {
                    return d3.area().interpolate(interpolate).defined(defined).x((d, i) {
                ...
                areaPaths.watchTransition(renderWatch, "line: areaPaths").attr("d", (d) {
                    return d3.area().interpolate(interpolate).defined(defined).x((d, i) {
                ...
                var linePaths = groupsEntries.selectAll("path.nv-line").data((d) {
                    return [d.values];
                });
                linePaths.enter().append("path").attr("class", "nv-line").attr("d", d3.line().curve(curve).defined(defined).x((d, i) {
                    return nv.utils.NaNtoZero(x0(getX(d, i)));
                }).y((d, i) {
                    return nv.utils.NaNtoZero(y0(getY(d, i)));
                }));
                linePaths.watchTransition(renderWatch, "line: linePaths").attr("d", d3.line().curve(curve).defined(defined).x((d, i) {
                    return nv.utils.NaNtoZero(x(getX(d, i)));
                }).y((d, i) {
                    return nv.utils.NaNtoZero(y(getY(d, i)));
                }));
        ...
        // Pass through events
        scatter.dispatch.on("elementClick", () {
            dispatch.apply("elementClick", this, arguments);
        });
        scatter.dispatch.on("elementMouseover", () {
            dispatch.apply("elementMouseover", this, arguments);
        });
        scatter.dispatch.on("elementMouseout", () {
    ...
    nv.models.lineChart = () {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                lines.width(availableWidth).height(availableHeight).color(data.map((d, i) {
                    return d.color || color(d, i);
                }).filter((d, i) {
                    return !data[i].disabled;
                }));
                ...
                //============================================================
                if (!focusEnable && identical(focus.brush.extent(), null)) {
                ...
                interactiveLayer.dispatch.on("elementMousemove", (e) {
                    ...
                    data.filter((series, i) {
                        ...
                        var extent = !identical(focus.brush.extent(), null) ? (focus.brush.empty() ? focus.xScale().domain() : focus.brush.extent()) : x.domain();
                        var currentValues = series.values.filter((d, i) {
                        ...
                        if (currentValues.length > 0) {
                            ...
                            if (!identical(pointYValue, null)) {
                                lines.highlightPoint(i, series.values.indexOf(point), true);
                            }
                            if (identical(point, undefined)) return;
                            if (identical(singlePoint, undefined)) singlePoint = point;
                            if (identical(pointXLocation, undefined)) pointXLocation = chart.xScale()(chart.x()(point, pointIndex));
                            allData.push(key: series.key, value: pointYValue, color: color(series, series.seriesIndex), data: point);
                        }
                    });
                    //Highlight the tooltip entry based on which point the mouse is closest to.
                    if (allData.length > 2) {
                    ...
                    var defaultValueFormatter = (d, i) {
                        return d == null ? "N/A" : yAxis.tickFormat()(d);
                    };
                    if (!identical(, "undefined")) {
                        interactiveLayer.tooltip.valueFormatter(interactiveLayer.tooltip.valueFormatter() || defaultValueFormatter).data(value: chart.x()(singlePoint, pointIndex), index: pointIndex, series: allData)();
                        interactiveLayer.renderGuideLine(pointXLocation);
                    }
                });
                interactiveLayer.dispatch.on("elementClick", (e) {
                    ...
                    data.filter((series, i) {
                        ...
                        allData.push(point: point, pointIndex: pointIndex, pos: [pointXLocation, yPos], seriesIndex: series.seriesIndex, series: series);
                    });
                ...
                dispatch.on("changeState", (e) {
                    if (!identical(, "undefined") && identical(data.length, e.disabled.length)) {
                        data.forEach((series, i) {
                            series.disabled = e.disabled[i];
                        });
                        state.disabled = e.disabled;
                ...
                onBrush(extent) {
                    // Update Main (Focus)
                    var focusLinesWrap = g.select(".nv-focus .nv-linesWrap").datum(data.filter((d) {
                        return !d.disabled;
                    }).map((d, i) {
                        return {
                            "key": d.key,
        ...
        chart._options = Object.create({}, width: {
            ...
            "set": (_) {
                ...
                focus.margin.right = !identical(_.right, undefined) ? _.right : focus.margin.right;
                focus.margin.bottom = !identical(_.bottom, undefined) ? _.bottom : focus.margin.bottom;
                focus.margin.left = !identical(_.left, undefined) ? _.left : focus.margin.left;
            }
        }, margin: {
            "get": () {
                return margin;
    ...
    nv.models.linePlusBarChart = () {
        ...
        chart(selection) {
            selection.each((data) {
                ...
                // Setup Scales
                var dataBars = data.filter((d) {
                    return !d.disabled && d.bar;
                });
                var dataLines = data.filter((d) {
                    return !d.bar;
                });
                ...
                x2.domain(d3.extent(d3.merge(series1.concat(series2)), (d) {
                    return d.x;
                ...
                if (!showLegend) {
                    ...
                    g.select(".nv-legendWrap").datum(data.map((series) {
                        series.originalKey = identical(series.originalKey, undefined) ? series.key : series.originalKey;
                        if (switchYAxisOrder) {
                ...
                bars2.width(availableWidth).height(availableHeight2).color(data.map((d, i) {
                    return d.color || color(d, i);
                }).filter((d, i) {
                    return !data[i].disabled && data[i].bar;
                }));
                lines2.width(availableWidth).height(availableHeight2).color(data.map((d, i) {
                    return d.color || color(d, i);
                }).filter((d, i) {
                    return !data[i].disabled && !data[i].bar;
                }));
                ...
                updateBrushBG() {
                    if (!brush.empty()) brush.extent(brushExtent);
                    brushBG.data([brush.empty() ? x2.domain() : brushExtent]).each((d, i) {
                ...
                onBrush() {
                    ...
                    bars.width(availableWidth).height(availableHeight1).color(data.map((d, i) {
                        return d.color || color(d, i);
                    }).filter((d, i) {
                        return !data[i].disabled && data[i].bar;
                    }));
        ...
        //------------------------------------------------------------
        lines.dispatch.on("elementMouseover.tooltip", (evt) {
            tooltip.duration(100).valueFormatter((d, i) {
        ...
        bars.dispatch.on("elementMouseover.tooltip", (evt) {
            ...
            tooltip.duration(0).valueFormatter((d, i) {
        ...
        chart._options = Object.create({}, width: {
            ...
            "set": (_) {
                margin2.top = !identical(_.top, undefined) ? _.top : margin2.top;
                margin2.right = !identical(_.right, undefined) ? _.right : margin2.right;
                margin2.bottom = !identical(_.bottom, undefined) ? _.bottom : margin2.bottom;
                margin2.left = !identical(_.left, undefined) ? _.left : margin2.left;
            }
        }, duration: {
            "get": () {
                return transitionDuration;
            ...
            "set": (_) {
                ...
                if (!identical(switchYAxisOrder, _)) {
                    var y1 = y1Axis;
                    y1Axis = y2Axis;
                    y2Axis = y1;
                    var y3 = y3Axis;
    ...
    nv.models.multiBar = () {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                var endFn = (d, i) {
                    if (identical(d.series, data.length - 1) && identical(i, data[0].values.length - 1)) return true;
                    return false;
                };
                ...
                if (stacked) {
                    var parsed = d3.layout.stack().offset(stackOffset).values((d) {
                        return d.values;
                    }).y(getY)(!data.length && hideable ? hideable : data);
                    parsed.forEach((series, i) {
                ...
                // remap and flatten the data for use in calculating the scales' domains
                var seriesData = (xDomain && yDomain) ? [] : data.map((d, idx) {
                    return d.values.map((d, i) {
                        return {
                            "x": getX(d, i),
                            "y": getY(d, i),
                ...
                groups.enter().append("g").style("stroke-opacity", 1e-6).style("fill-opacity", 1e-6);
                var exitTransition = renderWatch.transition(groups.exit().selectAll("rect.nv-bar"), "multibarExit", Math.min(100, duration)).attr("y", (d, i, j) {
                    var yVal = y0(0) || 0;
                    if (stacked) {
                ...
                if (exitTransition.delay) exitTransition.delay((d, i) {
                ...
                var bars = groups.selectAll("rect.nv-bar").data((d) {
                    return (hideable && !data.length) ? hideable.values : d.values;
                });
                bars.exit().remove();
                var barsEnter = bars.enter().append("rect").attr("class", (d, i) {
                    return getY(d, i) < 0 ? "nv-bar negative" : "nv-bar positive";
                }).attr("x", (d, i, j) {
                    return stacked && !data[j].nonStackable ? 0 : (j * x.rangeBand() / data.length);
                }).attr("y", (d, i, j) {
                    return y0(stacked && !data[j].nonStackable ? d.y0 : 0) || 0;
                }).attr("height", 0).attr("width", (d, i, j) {
                    return x.rangeBand() / (stacked && !data[j].nonStackable ? 1 : data.length);
                }).attr("transform", (d, i) {
                    return "translate(" + x(getX(d, i)) + ",0)";
                });
                bars.style("fill", (d, i, j) {
                    return color(d, j, i);
                }).style("stroke", (d, i, j) {
                    return color(d, j, i);
                }).on("mouseover", (d, i, j) {
                    d3.select(this).classed("hover", true);
                    dispatch.elementMouseover(data: d, index: i, series: data[j], color: d3.select(this).style("fill"));
                }).on("mouseout", (d, i, j) {
                    d3.select(this).classed("hover", false);
                    dispatch.elementMouseout(data: d, index: i, series: data[j], color: d3.select(this).style("fill"));
                }).on("mousemove", (d, i, j) {
                    dispatch.elementMousemove(data: d, index: i, series: data[j], color: d3.select(this).style("fill"));
                }).on("click", (d, i, j) {
                    var element = this;
                    dispatch.elementClick(data: d, index: i, series: data[j], color: d3.select(this).style("fill"), event: d3.event, element: element);
                    d3.event.stopPropagation();
                }).on("dblclick", (d, i, j) {
                    dispatch.elementDblClick(data: d, index: i, series: data[j], color: d3.select(this).style("fill"));
                    d3.event.stopPropagation();
                });
                bars.attr("class", (d, i) {
                    return getY(d, i) < 0 ? "nv-bar negative" : "nv-bar positive";
                ...
                if (barColor) {
                    if (!disabled) disabled = data.map(() {
                        return true;
                    });
                    bars.style("fill", (d, i, j) {
                        return d3.rgb(barColor(d, i)).darker(disabled.map((d, i) {
                            return i;
                        }).filter((d, i) {
                            return !disabled[i];
                        })[j]).toString();
                ...
                var barSelection = bars.watchTransition(renderWatch, "multibar", Math.min(250, duration)).delay((d, i) {
                    return i * duration / data[0].values.length;
                });
                if (stacked) {
                    barSelection.attr("y", (d, i, j) {
                        var yVal = 0;
                        ...
                        if (data[j].nonStackable) {
                            ...
                            if (!identical(data.length, nonStackableCount)) {
                    ...
                    barSelection.attr("x", (d, i) {
                        return d.series * x.rangeBand() / data.length;
                    }).attr("width", x.rangeBand() / data.length).attr("y", (d, i) {
    ...
    nv.models.multiBarChart = () {
        ...
        xAxis.orient("bottom").tickPadding(7).showMaxMin(false).tickFormat((d) {
            return d;
        });
        yAxis.orient((rightAlignYAxis) ? "right" : "left").tickFormat(d3.format(",.1f"));
        tooltip.duration(0).valueFormatter((d, i) {
        ...
        interactiveLayer.tooltip.duration(0).valueFormatter((d, i) {
            return yAxis.tickFormat()(d, i);
        }).headerFormatter((d, i) {
            return xAxis.tickFormat()(d, i);
        });
        ...
        var stateSetter = (data) {
            return (state) {
                if (!identical(state.stacked, undefined)) stacked = state.stacked;
                if (!identical(state.active, undefined)) data.forEach((series, i) {
                    series.disabled = !state.active[i];
                });
            };
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                // Main Chart Component(s)
                multibar.disabled(data.map((series) {
                    return series.disabled;
                })).width(availableWidth).height(availableHeight).color(data.map((d, i) {
                    return d.color || color(d, i);
                }).filter((d, i) {
                ...
                if (showXAxis) {
                    ...
                    if (staggerLabels) {
                        ...
                        g.selectAll(".nv-x.nv-axis .nv-axisMaxMin text").attr("transform", (d, i) {
                            return getTranslate(0, (identical(i, 0) || !identical(totalInBetweenTicks % 2, 0)) ? staggerDown : staggerUp);
                        });
                    }
                    if (wrapLabels) {
                        g.selectAll(".tick text").call(nv.utils.wrapTicks, chart.xAxis.rangeBand());
                    }
                    if (reduceXTicks) xTicks.filter((d, i) {
                        return !identical(i % Math.ceil(data[0].values.length / (availableWidth / 100)), 0);
                ...
                if (useInteractiveGuideline) {
                    interactiveLayer.dispatch.on("elementMousemove", (e) {
                        ...
                        data.filter((series, i) {
                            ...
                            xValue = point.x;
                            if (identical(singlePoint, undefined)) singlePoint = point;
                            if (identical(pointXLocation, undefined)) pointXLocation = e.mouseX;
                            allData.push(key: series.key, value: chart.y()(point, pointIndex), color: color(series, series.seriesIndex), data: series.values[pointIndex]);
                        });
                        interactiveLayer.tooltip.data(value: xValue, index: pointIndex, series: allData)();
                        interactiveLayer.renderGuideLine(pointXLocation);
                    });
                    interactiveLayer.dispatch.on("elementMouseout", (e) {
                    ...
                    multibar.dispatch.on("elementMouseover.tooltip", (evt) {
                        evt.value = chart.x()(evt.data);
                        evt["series"] = {
                            "key": evt.data.key,
                            "value": chart.y()(evt.data),
                    ...
                    multibar.dispatch.on("elementMouseout.tooltip", (evt) {
                        tooltip.hidden(true);
                    });
                    multibar.dispatch.on("elementMousemove.tooltip", (evt) {
                        tooltip();
                    });
                }
            });
    ...
    nv.models.multiBarHorizontal = () {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                container = d3.select(this);
                nv.utils.initSVG(container);
                if (stacked) data = d3.layout.stack().offset("zero").values((d) {
                    return d.values;
                }).y(getY)(data);
                //add series index and key to each data point for reference
                data.forEach((series, i) {
                ...
                // HACK for negative value stacking
                if (stacked) data[0].values.map((d, i) {
                    var posBase = 0,
                        negBase = 0;
                    data.map((d) {
                        var f = d.values[i];
                ...
                if (showValues && !stacked) y.range(yRange || [(y.domain()[0] < 0 ? valuePadding : 0), availableWidth - (y.domain()[1] > 0 ? valuePadding : 0)]);
                ...
                if (getYerr(data[0], 0)) {
                    ...
                    bars.select("polyline").attr("fill", "none").attr("points", (d, i) {
                ...
                if (showValues && !stacked) {
                    bars.select("text").attr("text-anchor", (d, i) {
                        return getY(d, i) < 0 ? "end" : "start";
                    }).attr("y", x.rangeBand() / (data.length * 2)).attr("dy", ".32em").text((d, i) {
                        var t = valueFormat(getY(d, i)),
                            yerr = getYerr(d, i);
                        if (identical(yerr, undefined)) return t;
                        if (!yerr.length) return t + "±" + valueFormat(Math.abs(yerr));
                        return t + "+" + valueFormat(Math.abs(yerr[1])) + "-" + valueFormat(Math.abs(yerr[0]));
                    });
                    bars.watchTransition(renderWatch, "multibarhorizontal: bars").select("text").attr("x", (d, i) {
                ...
                if (showBarLabels && !stacked) {
                    ...
                    bars.select("text.nv-bar-label").attr("text-anchor", (d, i) {
                        return getY(d, i) < 0 ? "start" : "end";
                    }).attr("y", x.rangeBand() / (data.length * 2)).attr("dy", ".32em").text((d, i) {
                        return getX(d, i);
                    });
                    bars.watchTransition(renderWatch, "multibarhorizontal: bars").select("text.nv-bar-label").attr("x", (d, i) {
                ...
                if (stacked) bars.watchTransition(renderWatch, "multibarhorizontal: bars").attr("transform", (d, i) {
                    return "translate(" + y(d.y1) + "," + x(getX(d, i)) + ")";
                }).select("rect").attr("width", (d, i) {
                    return Math.abs(y(getY(d, i) + d.y0) - y(d.y0)) || 0;
                }).attr("height", x.rangeBand());
                else bars.watchTransition(renderWatch, "multibarhorizontal: bars").attr("transform", (d, i) {
                    //TODO: stacked must be all positive or all negative, not both?
                    return "translate(" + (getY(d, i) < 0 ? y(getY(d, i)) : y(0)) + "," + (d.series * x.rangeBand() / data.length + x(getX(d, i))) + ")";
                }).select("rect").attr("height", x.rangeBand() / data.length).attr("width", (d, i) {
                    return Math.max(Math.abs(y(getY(d, i)) - y(0)), 1) || 0;
                });
                //store old scales for use in transitions on update
                x0 = x.copy();
    ...
    nv.models.multiBarHorizontalChart = () {
        ...
        xAxis.orient("left").tickPadding(5).showMaxMin(false).tickFormat((d) {
            return d;
        });
    ...
    nv.models.multiChart = () {
        ...
        chart(selection) {
            selection.each((data) {
                ...
                var availableWidth = nv.utils.availableWidth(width, container, margin),
                    availableHeight = nv.utils.availableHeight(height, container, margin);
                var dataLines1 = data.filter((d) {
                    return d.type == "line" && d.yAxis == 1;
                });
                var dataLines2 = data.filter((d) {
                    return d.type == "line" && d.yAxis == 2;
                });
                var dataScatters1 = data.filter((d) {
                    return d.type == "scatter" && d.yAxis == 1;
                });
                var dataScatters2 = data.filter((d) {
                    return d.type == "scatter" && d.yAxis == 2;
                });
                var dataBars1 = data.filter((d) {
                    return d.type == "bar" && d.yAxis == 1;
                });
                var dataBars2 = data.filter((d) {
                    return d.type == "bar" && d.yAxis == 2;
                });
                var dataStack1 = data.filter((d) {
                    return d.type == "area" && d.yAxis == 1;
                });
                var dataStack2 = data.filter((d) {
                ...
                x.domain(d3.extent(d3.merge(series1.concat(series2)), (d) {
                    return d.x;
                })).range([0, availableWidth]);
                ...
                if (!showLegend) {
                    ...
                    g.select(".legendWrap").datum(data.map((series) {
                        series.originalKey = identical(series.originalKey, undefined) ? series.key : series.originalKey;
                ...
                lines1.width(availableWidth).height(availableHeight).interpolate(interpolate).color(color_array.filter((d, i) {
                    return !data[i].disabled && data[i].yAxis == 1 && data[i].type == "line";
                }));
                lines2.width(availableWidth).height(availableHeight).interpolate(interpolate).color(color_array.filter((d, i) {
                    return !data[i].disabled && data[i].yAxis == 2 && data[i].type == "line";
                }));
                scatters1.width(availableWidth).height(availableHeight).color(color_array.filter((d, i) {
                    return !data[i].disabled && data[i].yAxis == 1 && data[i].type == "scatter";
                }));
                scatters2.width(availableWidth).height(availableHeight).color(color_array.filter((d, i) {
                    return !data[i].disabled && data[i].yAxis == 2 && data[i].type == "scatter";
                }));
                bars1.width(availableWidth).height(availableHeight).color(color_array.filter((d, i) {
                    return !data[i].disabled && data[i].yAxis == 1 && data[i].type == "bar";
                }));
                bars2.width(availableWidth).height(availableHeight).color(color_array.filter((d, i) {
                    return !data[i].disabled && data[i].yAxis == 2 && data[i].type == "bar";
                }));
                stack1.width(availableWidth).height(availableHeight).interpolate(interpolate).color(color_array.filter((d, i) {
                    return !data[i].disabled && data[i].yAxis == 1 && data[i].type == "area";
                }));
                stack2.width(availableWidth).height(availableHeight).interpolate(interpolate).color(color_array.filter((d, i) {
                    return !data[i].disabled && data[i].yAxis == 2 && data[i].type == "area";
                }));
                g.attr("transform", "translate(" + margin.left + "," + margin.top + ")");
                var lines1Wrap = g.select(".lines1Wrap").datum(dataLines1.filter((d) {
                    return !d.disabled;
                }));
                var scatters1Wrap = g.select(".scatters1Wrap").datum(dataScatters1.filter((d) {
                    return !d.disabled;
                }));
                var bars1Wrap = g.select(".bars1Wrap").datum(dataBars1.filter((d) {
                    return !d.disabled;
                }));
                var stack1Wrap = g.select(".stack1Wrap").datum(dataStack1.filter((d) {
                    return !d.disabled;
                }));
                var lines2Wrap = g.select(".lines2Wrap").datum(dataLines2.filter((d) {
                    return !d.disabled;
                }));
                var scatters2Wrap = g.select(".scatters2Wrap").datum(dataScatters2.filter((d) {
                    return !d.disabled;
                }));
                var bars2Wrap = g.select(".bars2Wrap").datum(dataBars2.filter((d) {
                    return !d.disabled;
                }));
                var stack2Wrap = g.select(".stack2Wrap").datum(dataStack2.filter((d) {
                    return !d.disabled;
                }));
                var extraValue1BarStacked = [];
                if (bars1.stacked() && dataBars1.length) {
                    var extraValue1BarStacked = dataBars1.filter((d) {
                        return !d.disabled;
                    }).map((a) {
                        return a.values;
                    });
                    if (extraValue1BarStacked.length > 0) extraValue1BarStacked = extraValue1BarStacked.reduce((a, b) {
                        return a.map((aVal, i) {
                            return {
                                "x": aVal.x,
                                "y": aVal.y + b[i].y
                ...
                if (bars2.stacked() && dataBars2.length) {
                    var extraValue2BarStacked = dataBars2.filter((d) {
                        return !d.disabled;
                    }).map((a) {
                        return a.values;
                    });
                    if (extraValue2BarStacked.length > 0) extraValue2BarStacked = extraValue2BarStacked.reduce((a, b) {
                        return a.map((aVal, i) {
                            return {
                                "x": aVal.x,
                                "y": aVal.y + b[i].y
                ...
                getStackedAreaYs(series) {
                    return d3.transpose(series).map((x) {
                        return x.map((g) {
                            return g.y;
                        });
                    }).map((x) {
                ...
                yScale1.domain(yDomain1 || d3.extent(d3.merge(series1).concat(extraValue1BarStacked), (d) {
                    return d.y;
                })).range([0, availableHeight]);
                yScale2.domain(yDomain2 || d3.extent(d3.merge(series2).concat(extraValue2BarStacked), (d) {
                    return d.y;
                })).range([0, availableHeight]);
                ...
                //------------------------------------------------------------
                mouseover_line(evt) {
                    var yaxis = identical(evt.series.yAxis, 2) ? yAxis2 : yAxis1;
                    ...
                    tooltip.duration(0).headerFormatter((d, i) {
                        return xAxis.tickFormat()(d, i);
                    }).valueFormatter((d, i) {
                        return yaxis.tickFormat()(d, i);
                    }).data(evt).hidden(false);
                }
                mouseover_scatter(evt) {
                    var yaxis = identical(evt.series.yAxis, 2) ? yAxis2 : yAxis1;
                    evt.value = evt.point.x;
                    evt.series = {
                        "value": evt.point.y,
                    ...
                    tooltip.duration(100).headerFormatter((d, i) {
                        return xAxis.tickFormat()(d, i);
                    }).valueFormatter((d, i) {
                        return yaxis.tickFormat()(d, i);
                    }).data(evt).hidden(false);
                ...
                highlightPoint(series, pointIndex, b, pointYValue) {
                    var chartMap = {
                        "line": {
                            "yAxis1": {
                                "chart": lines1,
                    ...
                    var seriesIndex = relevantDatasets.reduce((seriesIndex, dataSet, i) {
                        return identical(dataSet.key, series.key) ? i : seriesIndex;
                    }, 0);
                    try {
                ...
                if (useInteractiveGuideline) {
                    interactiveLayer.dispatch.on("elementMousemove", (e) {
                        ...
                        data.filter((series, i) {
                            ...
                            var point = currentValues[pointIndex];
                            var pointYValue = chart.y()(point, pointIndex);
                            if (!identical(pointYValue, null) && !isNaN(pointYValue) && !series.noHighlightSeries) {
                                highlightPoint(series, pointIndex, true);
                            }
                            if (identical(point, undefined)) return;
                            if (identical(singlePoint, undefined)) singlePoint = point;
                            if (identical(pointXLocation, undefined)) pointXLocation = x(chart.x()(point, pointIndex));
                            allData.push(key: series.key, value: pointYValue, color: color(series, series.seriesIndex), data: point, yAxis: series.yAxis == 2 ? yAxis2 : yAxis1);
                        });
                        var defaultValueFormatter = (d, i) {
                            var yAxis = allData[i].yAxis;
                            return d == null ? "N/A" : yAxis.tickFormat()(d);
                        };
                        interactiveLayer.tooltip.headerFormatter((d, i) {
                            return xAxis.tickFormat()(d, i);
                        }).valueFormatter(interactiveLayer.tooltip.valueFormatter() || defaultValueFormatter).data(value: chart.x()(singlePoint, pointIndex), index: pointIndex, series: allData)();
                        interactiveLayer.renderGuideLine(pointXLocation);
                    });
                    interactiveLayer.dispatch.on("elementMouseout", (e) {
                        clearHighlights();
                    ...
                    lines1.dispatch.on("elementMouseout.tooltip", (evt) {
                        tooltip.hidden(true);
                    });
                    lines2.dispatch.on("elementMouseout.tooltip", (evt) {
                        tooltip.hidden(true);
                    });
                    scatters1.dispatch.on("elementMouseover.tooltip", mouseover_scatter);
                    scatters2.dispatch.on("elementMouseover.tooltip", mouseover_scatter);
                    scatters1.dispatch.on("elementMouseout.tooltip", (evt) {
                        tooltip.hidden(true);
                    });
                    scatters2.dispatch.on("elementMouseout.tooltip", (evt) {
                        tooltip.hidden(true);
                    });
                    stack1.dispatch.on("elementMouseover.tooltip", mouseover_stack);
                    stack2.dispatch.on("elementMouseover.tooltip", mouseover_stack);
                    stack1.dispatch.on("elementMouseout.tooltip", (evt) {
                        tooltip.hidden(true);
                    });
                    stack2.dispatch.on("elementMouseout.tooltip", (evt) {
                        tooltip.hidden(true);
                    });
                    bars1.dispatch.on("elementMouseover.tooltip", mouseover_bar);
                    bars2.dispatch.on("elementMouseover.tooltip", mouseover_bar);
                    bars1.dispatch.on("elementMouseout.tooltip", (evt) {
                        tooltip.hidden(true);
                    });
                    bars2.dispatch.on("elementMouseout.tooltip", (evt) {
                        tooltip.hidden(true);
                    });
                    bars1.dispatch.on("elementMousemove.tooltip", (evt) {
                        tooltip();
                    });
                    bars2.dispatch.on("elementMousemove.tooltip", (evt) {
                        tooltip();
                    });
                }
            });
        ...
        chart._options = Object.create({}, width: {
            ...
            "set": (_) {
                duration = _;
                [lines1, lines2, stack1, stack2, scatters1, scatters2, xAxis, yAxis1, yAxis2].forEach((model) {
    ...
    nv.models.ohlcBar = () {
        ...
        chart(selection) {
            selection.each((data) {
                ...
                ticks.exit().remove();
                ticks.enter().append("path").attr("class", (d, i, j) {
                    return (getOpen(d, i) > getClose(d, i) ? "nv-tick negative" : "nv-tick positive") + " nv-tick-" + j + "-" + i;
                }).attr("d", (d, i) {
                ...
                d3.transition(ticks).attr("transform", (d, i) {
                    return "translate(" + x(getX(d, i)) + "," + y(getHigh(d, i)) + ")";
                }).attr("d", (d, i) {
                    var w = (availableWidth / data[0].values.length) * .9;
                    return "m0,0l0," + (y(getOpen(d, i)) - y(getHigh(d, i))) + "l" + (-w / 2) + ",0l" + (w / 2) + ",0l0," + (y(getLow(d, i)) - y(getOpen(d, i))) + "l0," + (y(getClose(d, i)) - y(getLow(d, i))) + "l" + (w / 2) + ",0l" + (-w / 2) + ",0z";
    ...
    nv.models.parallelCoordinates = () {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                if (identical(data[0].values, undefined)) {
                    var newData = [];
                    data.forEach((d) {
                        var val = {};
                        var key = Object.keys(d);
                        key.forEach((k) {
                            if (!identical(k, "name")) val[k] = d[k];
                        });
                        newData.push(key: d.name, values: val);
                    });
                    data = newData;
                }
                var dataValues = data.map((d) {
                    return d.values;
                });
                if (identical(active.length, 0)) {
                    active = data;
                };
                dimensionNames = dimensionData.sort((a, b) {
                    return a.currentPosition - b.currentPosition;
                }).map((d) {
                    return d.key;
                });
                enabledDimensions = dimensionData.filter((d) {
                    return !d.disabled;
                });
                // Setup Scales
                x.rangePoints([0, availableWidth], 1).domain(enabledDimensions.map((d) {
                    return d.key;
                }));
                ...
                dimensionNames.forEach((d) {
                    var extent = d3.extent(dataValues, (p) {
                        return +p[d];
                    });
                    var min = extent[0];
                    var max = extent[1];
                    ...
                    var f = filters.filter((k) {
                        return k.dimension == d;
                    });
                    if (!identical(f.length, 0)) {
                ...
                if (!isNaN(step)) {
                    ...
                    missingValueslineText.attr("y", availableHeight).attr("x", availableWidth - 92 - step / 2).text((d) {
                        return d;
                    });
                }
                ...
                foreground.attr("d", path).style("stroke-width", (d, i) {
                ...
                foreground.on("mouseover", (d, i) {
                    d3.select(this).classed("hover", true).style("stroke-width", d.strokeWidth + 2 + "px").style("stroke-opacity", 1);
                    dispatch.elementMouseover(label: d.name, color: d.color || color(d, i), values: d.values, dimensions: enabledDimensions);
                });
                foreground.on("mouseout", (d, i) {
                    d3.select(this).classed("hover", false).style("stroke-width", d.strokeWidth + "px").style("stroke-opacity", 0.7);
                    dispatch.elementMouseout(label: d.name, index: i);
                });
                foreground.on("mousemove", (d, i) {
                    dispatch.elementMousemove();
                });
                foreground.on("click", (d) {
                    dispatch.elementClick(id: d.id);
                });
                // Add a group element for each dimension.
                dimensions = g.selectAll(".dimension").data(enabledDimensions);
                var dimensionsEnter = dimensions.enter().append("g").attr("class", "nv-parallelCoordinates dimension");
                dimensions.attr("transform", (d) {
                    return "translate(" + x(d.key) + ",0)";
                });
                dimensionsEnter.append("g").attr("class", "nv-axis");
                // Add an axis and title.
                dimensionsEnter.append("text").attr("class", "nv-label").style("cursor", "move").attr("dy", "-1em").attr("text-anchor", "middle").on("mouseover", (d, i) {
                    dispatch.elementMouseover(label: d.tooltip || d.key, color: d.color);
                }).on("mouseout", (d, i) {
                ...
                dimensions.select(".nv-label").text((d) {
                    return d.key;
                });
                // Add and store a brush for each axis.
                restoreBrush(displayBrush);
                var actives = dimensionNames.filter((p) {
                ...
                foreground.style("display", (d) {
                    var isActive = actives.every((p, i) {
                ...
                path(d) {
                    return line(enabledDimensions.map((p) {
                        ...
                        if (!identical(missingValuesline, undefined)) {
                ...
                restoreBrush(visible) {
                    ...
                    dimensions.select(".nv-brushBackground").each((d) {
                ...
                brushstart() {
                    ...
                    if (identical(displayBrush, false)) {
                        displayBrush = true;
                        restoreBrush(true);
                    }
                }
                // Handles a brush event, toggling the display of foreground lines.
                brush() {
                    actives = dimensionNames.filter((p) {
                        return !y[p].brush.empty();
                    });
                    extents = actives.map((p) {
                        return y[p].brush.extent();
                ...
                brushend() {
                    ...
                    filters.forEach((f) {
                        if (identical(f.extent[0], y[f.dimension].brush.y().domain()[0]) && axisWithUndefinedValues.indexOf(f.dimension) >= 0) f.hasNaN = true;
                        if (f.extent[1] < y[f.dimension].domain()[0]) f.hasOnlyNaN = true;
                    });
                    dispatch.brushEnd(active, hasActiveBrush);
                }
                updateTicks() {
                    dimensions.select(".nv-axis").each((d, i) {
                        var f = filters.filter((k) {
                ...
                dragStart(d) {
                    dragging[d.key] = this.parentNode.___origin__ = x(d.key);
                    background.attr("visibility", "hidden");
                }
                dragMove(d) {
                    dragging[d.key] = Math.min(availableWidth, Math.max(0, this.parentNode.___origin__ += d3.event.x));
                    foreground.attr("d", path);
                    enabledDimensions.sort((a, b) {
                        return dimensionPosition(a.key) - dimensionPosition(b.key);
                    });
                    enabledDimensions.forEach((d, i) {
                        return d.currentPosition = i;
                    });
                    x.domain(enabledDimensions.map((d) {
                        return d.key;
                    }));
                    dimensions.attr("transform", (d) {
        ...
        chart._options = Object.create({}, width: {
            ...
            "set": (_) {
                ...
                if (identical(dimensionData.length, 0)) {
                    _.forEach((k) {
    ...
    nv.models.parallelCoordinatesChart = () {
        "use strict";
        //============================================================
        ...
        tooltip.contentGenerator((data) {
            var str = "<table><thead><tr><td class=\"legend-color-guide\"><div style=\"background-color:" + data.color + "\"></div></td><td><strong>" + data.key + "</strong></td></tr></thead>";
            if (!identical(data.series.length, 0)) {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                //set state.disabled
                state.disabled = dimensionData.map((d) {
                    return !!d.disabled;
                });
                //Keep dimensions position in memory
                dimensionData = dimensionData.map((d) {
                    d.disabled = !!d.disabled;
                    return d;
                });
                ...
                if (!showLegend) {
                    ...
                    legend.width(availableWidth).color((d) {
                        return "rgb(188,190,192)";
                    });
                    g.select(".nv-legendWrap").datum(dimensionData.sort((a, b) {
                ...
                parallelCoordinates.dispatch.on("brushEnd", (active, hasActiveBrush) {
                    if (hasActiveBrush) {
                        displayBrush = true;
                ...
                parallelCoordinates.dispatch.on("dimensionsOrder", (e) {
                    dimensionData.sort((a, b) {
                        return a.currentPosition - b.currentPosition;
                    });
                    var isSorted = false;
                    dimensionData.forEach((d, i) {
                        d.currentPosition = i;
                        if (!identical(d.currentPosition, d.originalPosition)) isSorted = true;
                    });
                ...
                dispatch.on("changeState", (e) {
                    if (!identical(, "undefined")) {
                        dimensionData.forEach((series, i) {
                            series.disabled = e.disabled[i];
                        });
                        state.disabled = e.disabled;
                    }
        ...
        //------------------------------------------------------------
        parallelCoordinates.dispatch.on("elementMouseover.tooltip", (evt) {
            var tp = {
                "key": evt.label,
                "color": evt.color,
                "series": []
            ...
            if (evt.values) {
                Object.keys(evt.values).forEach((d) {
                    var dim = evt.dimensions.filter((dd) {
                        return identical(dd.key, d);
                    })[0];
                    if (dim) {
                        var v;
        ...
        parallelCoordinates.dispatch.on("elementMouseout.tooltip", (evt) {
            tooltip.hidden(true);
        });
        parallelCoordinates.dispatch.on("elementMousemove.tooltip", () {
            tooltip();
        });
        //============================================================
    ...
    nv.models.pie = () {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                var availableWidth = width - margin.left - margin.right,
                    ...
                    arcsRadiusInner = [];
                container = d3.select(this);
                if (identical(arcsRadius.length, 0)) {
                    ...
                    if (growOnHover) {
                        ...
                        arcsRadiusInner = arcsRadius.map((d) {
                            return (d.inner - d.inner / 10) * radius;
                        });
                        donutRatio = d3.min(arcsRadius.map((d) {
                ...
                for (var i = 0; i < data[0].length; i++) {
                    ...
                    if (!identical(startAngle, false)) {
                        arc.startAngle(startAngle);
                        arcOver.startAngle(startAngle);
                    }
                    if (!identical(endAngle, false)) {
                ...
                var pie = d3.layout.pie().sort(null).value((d) {
                ...
                if (donut && title) {
                    ...
                    wrap.select(".nv-pie-title").style("text-anchor", "middle").text((d) {
                        return title;
                    }).style("font-size", (Math.min(availableWidth, availableHeight)) * donutRatio * 2 / (title.length + 2) + "px").attr("dy", "0.35em").attr("transform", (d, i) {
                ...
                ae.on("mouseover", (d, i) {
                    ...
                    dispatch.elementMouseover(data: d.data, index: i, color: d3.select(this).style("fill"), percent: (d.endAngle - d.startAngle) / (2 * Math.PI));
                });
                ae.on("mouseout", (d, i) {
                    d3.select(this).classed("hover", false);
                    if (growOnHover) {
                ...
                ae.on("click", (d, i) {
                    var element = this;
                    dispatch.elementClick(data: d.data, index: i, color: d3.select(this).style("fill"), event: d3.event, element: element);
                });
                ae.on("dblclick", (d, i) {
                    dispatch.elementDblClick(data: d.data, index: i, color: d3.select(this).style("fill"));
                });
                slices.attr("fill", (d, i) {
                    return color(d.data, i);
                });
                slices.attr("stroke", (d, i) {
                    return color(d.data, i);
                });
                var paths = ae.append("path").each((d) {
                    this._current = d;
                });
                slices.select("path").transition().duration(duration).attr("d", (d, i) {
                    return arcs[i](d);
                ...
                if (showLabels) {
                    ...
                    for (var i = 0; i < data[0].length; i++) {
                        ...
                        if (labelsOutside) {
                            if (donut) {
                                ...
                                if (!identical(startAngle, false)) labelsArc[i].startAngle(startAngle);
                                if (!identical(endAngle, false)) labelsArc[i].endAngle(endAngle);
                            }
                        } else if (!donut) {
                            labelsArc[i].innerRadius(0);
                        }
                    }
                    pieLabels.enter().append("g").classed("nv-label", true).each((d, i) {
                    ...
                    var avgHeight = 14;
                    var avgWidth = 140;
                    var createHashKey = (coordinates) {
                        return Math.floor(coordinates[0] / avgWidth) * avgWidth + "," + Math.floor(coordinates[1] / avgHeight) * avgHeight;
                    };
                    var getSlicePercentage = (d) {
                        return (d.endAngle - d.startAngle) / (2 * Math.PI);
                    };
                    pieLabels.watchTransition(renderWatch, "pie labels").attr("transform", (d, i) {
                        if (labelSunbeamLayout) {
                            d.outerRadius = arcsRadiusOuter[i] + 10;
                            d.innerRadius = arcsRadiusOuter[i] + 15;
                            var rotateAngle = (d.startAngle + d.endAngle) / 2 * (180 / Math.PI);
                    ...
                    pieLabels.select(".nv-label text").style("text-anchor", (d, i) {
        ...
        chart.dispatch = dispatch;
        chart.options = nv.utils.optionsFunc.bind(chart);
        chart._options = Object.create({}, arcsRadius: {
            "get": () {
                return arcsRadius;
            },
            "set": (_) {
    ...
    nv.models.pieChart = () {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                if (!showLegend) {
                    ...
                    if (identical(legendPosition, "top")) {
                        ...
                        wrap.select(".nv-legendWrap").attr("transform", "translate(0," + (-margin.top) + ")");
                    } else if (identical(legendPosition, "right")) {
                    ...
                    } else if (identical(legendPosition, "bottom")) {
                        legend.width(availableWidth).key(pie.x());
                        wrap.select(".nv-legendWrap").datum(data).call(legend);
        ...
        //------------------------------------------------------------
        pie.dispatch.on("elementMouseover.tooltip", (evt) {
            evt["series"] = {
                "key": chart.x()(evt.data),
                "value": chart.y()(evt.data),
                "color": evt.color,
        ...
        pie.dispatch.on("elementMouseout.tooltip", (evt) {
            tooltip.hidden(true);
        });
        pie.dispatch.on("elementMousemove.tooltip", (evt) {
            tooltip();
        });
        //============================================================
    ...
    nv.models.sankey = () {
        ...
        computeNodeLinks() {
            ...
            links.forEach((link) {
                var source = link.source,
                    target = link.target;
                if (identical(, "number")) source = link.source = nodes[link.source];
                if (identical(, "number")) target = link.target = nodes[link.target];
        ...
        computeNodeDepths(iterations) {
            ...
            var nodesByBreadth = d3.nest().key((d) {
                return d.x;
        ...
        sankey._options = Object.create({}, nodeWidth: {
            "get": () {
                return nodeWidth;
            },
            "set": (_) {
    ...
    nv.models.sankeyChart = () {
        ...
        var nodeFillColor = (d) {
            return d.color = color(d.name.replace(new RegExp(r ' .*'), ""));
        };
        var nodeStrokeColor = (d) {
            return d3.rgb(d.color).darker(2);
        };
        var nodeTitle = (d) {
            return d.name + "\n" + format(d.value);
        };
        var showError = (element, message) {
        ...
        chart(selection) {
            selection.each((data) {
                ...
                if ((identical(, "object") && data["nodes"].length) >= 0 && (identical(, "object") && data["links"].length) >= 0) {
                    isDataValid = true;
                }
                ...
                // add in the links
                var link = svg.append("g").selectAll(".link").data(data.links).enter().append("path").attr("class", "link").attr("d", path).style("stroke-width", (d) {
                ...
                // add in the nodes
                var node = svg.append("g").selectAll(".node").data(data.nodes).enter().append("g").attr("class", "node").attr("transform", (d) {
                    return "translate(" + d.x + "," + d.y + ")";
        ...
        //------------------------------------------------------------
        chart.options = nv.utils.optionsFunc.bind(chart);
        chart._options = Object.create({}, units: {
            "get": () {
                return units;
            },
            "set": (_) {
            ...
            "set": (_) {
                nodeFillColor = !identical(_.fillColor, undefined) ? _.fillColor : nodeFillColor;
                nodeStrokeColor = !identical(_.strokeColor, undefined) ? _.strokeColor : nodeStrokeColor;
                nodeTitle = !identical(_.title, undefined) ? _.title : nodeTitle;
            }
        });
        nv.utils.initOptions(chart);
        return chart;
    ...
    nv.models.scatter = () {
        ...
        //------------------------------------------------------------
        var x0, y0, z0, xDom, yDom, width0, height0, timeoutID, needsUpdate = false,
            renderWatch = nv.utils.renderWatch(dispatch, duration),
        ...
        getDiffs(d) {
            var i, key, val, cache = getCache(d),
                diffs = false;
            for (i = 1; i < arguments.length; i += 2) {
                key = arguments[i];
                val = arguments[i + 1](d[0], d[1]);
                if (!identical(cache[key], val) || !cache.hasOwnProperty(key)) {
                    cache[key] = val;
                    diffs = true;
                }
            }
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                x.domain(xDomain || d3.extent(seriesData.map((d) {
                    return d.x;
                }).concat(forceX)));
                ...
                if (logScale) {
                    var min = d3.min(seriesData.map((d) {
                        if (!identical(d.y, 0)) return d.y;
                    }));
                    y.clamp(true).domain(yDomain || d3.extent(seriesData.map((d) {
                        if (!identical(d.y, 0)) return d.y;
                        else return min * 0.1;
                    }).concat(forceY))).range(yRange || [availableHeight, 0]);
                } else {
                    y.domain(yDomain || d3.extent(seriesData.map((d) {
                        return d.y;
                    }).concat(forceY))).range(yRange || [availableHeight, 0]);
                }
                z.domain(sizeDomain || d3.extent(seriesData.map((d) {
                    return d.size;
                }).concat(forceSize))).range(sizeRange || _sizeRange_def);
                // If scale's domain don't have a range, slightly adjust to make one... so a chart can show a single data point
                singlePoint = identical(x.domain()[0], x.domain()[1]) || identical(y.domain()[0], y.domain()[1]);
                if (identical(x.domain()[0], x.domain()[1])) x.domain()[0] ? x.domain([x.domain()[0] - x.domain()[0] * 0.01, x.domain()[1] + x.domain()[1] * 0.01]) : x.domain([-1, 1]);
                if (identical(y.domain()[0], y.domain()[1])) y.domain()[0] ? y.domain([y.domain()[0] - y.domain()[0] * 0.01, y.domain()[1] + y.domain()[1] * 0.01]) : y.domain([-1, 1]);
                if (isNaN(x.domain()[0])) {
                    x.domain([-1, 1]);
                ...
                y0 = y0 || y;
                z0 = z0 || z;
                var scaleDiff = !identical(x(1), x0(1)) || !identical(y(1), y0(1)) || !identical(z(1), z0(1));
                width0 = width0 || width;
                height0 = height0 || height;
                var sizeDiff = !identical(width0, width) || !identical(height0, height);
                // Domain Diffs
                xDom = xDom || [];
                var domainDiff = !identical(xDom[0], x.domain()[0]) || !identical(xDom[1], x.domain()[1]);
                xDom = x.domain();
                yDom = yDom || [];
                domainDiff = domainDiff || !identical(yDom[0], y.domain()[0]) || !identical(yDom[1], y.domain()[1]);
                yDom = y.domain();
                // Setup containers and skeleton of chart
                var wrap = container.selectAll("g.nv-wrap.nv-scatter").data([data]);
                var wrapEnter = wrap.enter().append("g").attr("class", "nvd3 nv-wrap nv-scatter nv-chart-" + id).attr("transform", "translate(" + margin.left + "," + margin.top + ")");;
                var defsEnter = wrapEnter.append("defs");
                var gEnter = wrapEnter.append("g");
                ...
                updateInteractiveLayer() {
                    ...
                    if (identical(useVoronoi, true)) {
                        var vertices = d3.merge(data.map((group, groupIndex) {
                            return group.values.map((point, pointIndex) {
                        ...
                        var voronoi = d3.voronoi().extent([bounds[0], bounds[2]]).polygons(vertices).map((d, i) {
                            return {
                                "data": d,
                                "series": vertices[i][2],
                                "point": vertices[i][3]
                        ...
                        var vPointPaths = pointPaths.enter().append("svg:path").attr("d", (d) {
                            if (!d || !d.data || identical(d.data.length, 0)) return "M 0 0";
                        ...
                        if (clipVoronoi) {
                            ...
                            nvPointClips.selectAll("*").remove();
                            var pointClips = nvPointClips.selectAll("clipPath").data(vertices);
                            var vPointClips = pointClips.enter().append("svg:clipPath").attr("id", (d, i) {
                                return "nv-clip-" + id + "-" + i;
                            }).append("svg:circle").attr("cx", (d) {
                                return d[0];
                            }).attr("cy", (d) {
                                return d[1];
                            }).attr("r", clipRadius);
                        }
                        var mouseEventCallback = (el, d, mDispatch) {
                            if (needsUpdate) return 0;
                            var series = data[d.series];
                            if (identical(series, undefined)) return;
                            ...
                            dispatch.call(mDispatch, this, point: point, series: series, pos: pos, relativePos: [x(getX(point, d.point)) + margin.left, y(getY(point, d.point)) + margin.top], seriesIndex: d.series, pointIndex: d.point, event: d3.event, element: el);
                        };
                        vPointPaths.on("click", (d) {
                        ...
                        nvGroups.selectAll(".nv-group").selectAll(".nv-point").on("click", (d, i) {
                            ...
                            var element = this;
                            dispatch.elementClick(point: point, series: series, pos: [x(getX(point, i)) + margin.left, y(getY(point, i)) + margin.top], relativePos: [x(getX(point, i)) + margin.left, y(getY(point, i)) + margin.top], seriesIndex: d[0].series, pointIndex: i, event: d3.event, element: element);
                        }).on("dblclick", (d, i) {
                            if (needsUpdate || !data[d[0].series]) return 0;
                            var series = data[d[0].series],
                                point = series.values[i];
                            dispatch.elementDblClick(point: point, series: series, pos: [x(getX(point, i)) + margin.left, y(getY(point, i)) + margin.top], relativePos: [x(getX(point, i)) + margin.left, y(getY(point, i)) + margin.top], seriesIndex: d[0].series, pointIndex: i);
                        }).on("mouseover", (d, i) {
                            if (needsUpdate || !data[d[0].series]) return 0;
                            var series = data[d[0].series],
                                point = series.values[i];
                            dispatch.elementMouseover(point: point, series: series, pos: [x(getX(point, i)) + margin.left, y(getY(point, i)) + margin.top], relativePos: [x(getX(point, i)) + margin.left, y(getY(point, i)) + margin.top], seriesIndex: d[0].series, pointIndex: i, color: color(d[0], i));
                        }).on("mouseout", (d, i) {
                            if (needsUpdate || !data[d[0].series]) return 0;
                            var series = data[d[0].series],
                                point = series.values[i];
                            dispatch.elementMouseout(point: point, series: series, pos: [x(getX(point, i)) + margin.left, y(getY(point, i)) + margin.top], relativePos: [x(getX(point, i)) + margin.left, y(getY(point, i)) + margin.top], seriesIndex: d[0].series, pointIndex: i, color: color(d[0], i));
                        });
                    }
                }
                needsUpdate = true;
                ...
                groups.exit().remove();
                gGroups.attr("class", (d, i) {
                    return (d.classed || "") + " nv-group nv-series-" + i;
                }).classed("nv-noninteractive", !interactive).classed("hover", (d) {
                    return d.hover;
                });
                gGroups.watchTransition(renderWatch, "scatter: groups").style("fill", (d, i) {
                    return color(d, i);
                }).style("stroke", (d, i) {
                    return d.pointBorderColor || pointBorderColor || color(d, i);
                }).style("stroke-opacity", 1).style("fill-opacity", .5);
                // create the points, maintaining their IDs from the original data set
                var points = gGroups.selectAll("path.nv-point").data((d) {
                    return d.values.map((point, pointIndex) {
                        return [point, pointIndex];
                    }).filter((pointArray, pointIndex) {
                        return pointActive(pointArray[0], pointIndex);
                    });
                });
                points.enter().append("path").attr("class", (d) {
                ...
                }).attr("d", nv.utils.symbol().type((d) {
                    return getShape(d[0]);
                }).size((d) {
                    return z(getSize(d[0], d[1]));
                }));
                points.exit().each(delCache).remove();
                groups.exit().selectAll("path.nv-point").watchTransition(renderWatch, "scatter exit").attr("transform", (d) {
                ...
                }).watchTransition(renderWatch, "scatter points").attr("transform", (d) {
                    return "translate(" + nv.utils.NaNtoZero(x(getX(d[0], d[1]))) + "," + nv.utils.NaNtoZero(y(getY(d[0], d[1]))) + ")";
                });
                ...
                }).watchTransition(renderWatch, "scatter points").attr("d", nv.utils.symbol().type((d) {
                    return getShape(d[0]);
                }).size((d) {
                    return z(getSize(d[0], d[1]));
                }));
                ...
                if (showLabels) {
                    var titles = groups.selectAll(".nv-label").data((d) {
                        return d.values.map((point, pointIndex) {
                            return [point, pointIndex];
                        }).filter((pointArray, pointIndex) {
                            return pointActive(pointArray[0], pointIndex);
                    ...
                    titles.enter().append("text").style("fill", (d, i) {
                        return d.color;
                    }).style("stroke-opacity", 0).style("fill-opacity", 1).attr("transform", (d) {
                    ...
                    titles.exit().remove();
                    groups.exit().selectAll("path.nv-label").watchTransition(renderWatch, "scatter exit").attr("transform", (d) {
                    ...
                    titles.watchTransition(renderWatch, "scatter labels").text((d, i) {
                        return d[0].label;
                    }).attr("transform", (d) {
                        var dx = nv.utils.NaNtoZero(x(getX(d[0], d[1]))) + Math.sqrt(z(getSize(d[0], d[1])) / Math.PI) + 2;
                        return "translate(" + dx + "," + nv.utils.NaNtoZero(y(getY(d[0], d[1]))) + ")";
        ...
        chart._calls = new() {
            ...
            this.highlightPoint = (seriesIndex, pointIndex, isHoverOver) {
                nv.dom.write(() {
    ...
    nv.models.scatterChart = () {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                wrap.attr("transform", "translate(" + margin.left + "," + margin.top + ")");
                // Main Chart Component(s)
                scatter.width(availableWidth).height(availableHeight).color(data.map((d, i) {
                    d.color = d.color || color(d, i);
                    return d.color;
                }).filter((d, i) {
                    return !data[i].disabled;
                })).showLabels(showLabels);
                wrap.select(".nv-scatterWrap").datum(data.filter((d) {
                    return !d.disabled;
                })).call(scatter);
                wrap.select(".nv-regressionLinesWrap").attr("clip-path", "url(#nv-edge-clip-" + scatter.id() + ")");
                var regWrap = wrap.select(".nv-regressionLinesWrap").selectAll(".nv-regLines").data((d) {
                    return d;
                });
                regWrap.enter().append("g").attr("class", "nv-regLines");
                var regLine = regWrap.selectAll(".nv-regLine").data((d) {
                    return [d];
                });
                ...
                regLine.filter((d) {
                ...
                }).watchTransition(renderWatch, "scatterPlusLineChart: regline").attr("x1", x.range()[0]).attr("x2", x.range()[1]).attr("y1", (d, i) {
                    ...
                    return (d.disabled || identical(, "undefined") || identical(, "undefined")) ? 0 : 1;
                });
                // Setup Axes
                if (showXAxis) {
                    xAxis.scale(x)._ticks(nv.utils.calcTicksX(availableWidth / 100, data)).tickSize(-availableHeight, 0);
                ...
                // Setup Distribution
                distX.getData(scatter.x()).scale(x).width(availableWidth).color(data.map((d, i) {
                    return d.color || color(d, i);
                }).filter((d, i) {
                    return !data[i].disabled;
                }));
                gEnter.select(".nv-distWrap").append("g").attr("class", "nv-distributionX");
                g.select(".nv-distributionX").attr("transform", "translate(0," + y.range()[0] + ")").datum(data.filter((d) {
                    return !d.disabled;
                })).call(distX).style("opacity", () {
                    return showDistX ? "1" : "1e-6";
                }).watchTransition(renderWatch, "scatterPlusLineChart").style("opacity", () {
                    return showDistX ? "1" : "1e-6";
                });
                distY.getData(scatter.y()).scale(y).width(availableHeight).color(data.map((d, i) {
                    return d.color || color(d, i);
                }).filter((d, i) {
                    return !data[i].disabled;
                }));
                gEnter.select(".nv-distWrap").append("g").attr("class", "nv-distributionY");
                g.select(".nv-distributionY").attr("transform", "translate(" + (rightAlignYAxis ? availableWidth : -distY.size()) + ",0)").datum(data.filter((d) {
                    return !d.disabled;
                })).call(distY).style("opacity", () {
                ...
                scatter.dispatch.on("elementMouseout.tooltip", (evt) {
                    tooltip.hidden(true);
                ...
                scatter.dispatch.on("elementMouseover.tooltip", (evt) {
    ...
    nv.models.sparkline = () {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                var g = wrap.select("g");
                wrap.attr("transform", "translate(" + margin.left + "," + margin.top + ")");
                var paths = wrap.selectAll("path").data((d) {
                    return [d];
                });
                ...
                paths.style("stroke", (d, i) {
                    return d.color || color(d, i);
                }).attr("d", d3.svg.line().x((d, i) {
                    return x(getX(d, i));
                }).y((d, i) {
                    return y(getY(d, i));
                }));
                // TODO: Add CURRENT data point (Need Min, Mac, Current / Most recent)
                var points = wrap.selectAll("circle.nv-point").data((data) {
                    var yValues = data.map((d, i) {
                        return getY(d, i);
                    });
                    pointIndex(index) {
                        if (index != -1) {
                    ...
                    return [(showMinMaxPoints ? minPoint : null), (showMinMaxPoints ? maxPoint : null), (showCurrentPoint ? currentPoint : null)].filter((d) {
                        return d != null;
                    });
                });
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                if (showLastValue) {
                    ...
                    value.attr("x", availableWidth + (rightAlignValue ? margin.right : 0)).attr("y", alignValue ? (d) {
                        return y(d);
                    } : 0).style("fill", sparkline.color()(data[data.length - 1], data.length - 1)).text(yTickFormat(currentValue));
                }
                gEnter.select(".nv-hoverArea").append("rect").on("mousemove", sparklineHover).on("click", () {
                    paused = !paused;
                }).on("mouseout", () {
                    index = [];
                    updateValueLine();
                });
                g.select(".nv-hoverArea rect").attr("transform", (d) {
    ...
    nv.models.stackedArea = () {
        ...
        var margin = {
            ...
            interpolate = "linear",
            clipEdge = false,
            x, y, scatter = nv.models.scatter(),
            duration = 250,
            transformData = (d, y0, y) {
                d.display = {
                    "y": y,
                    "y0": y0
                };
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                var dataFiltered = data.filter((series) {
                    return !series.disabled;
                });
                data = d3.layout.stack().order(order).offset(offset).values((d) {
                    return d.values;
                }).x(getX).y(getY).out(transformData)(dataFiltered);
                // Setup containers and skeleton of chart
                ...
                scatter.width(availableWidth).height(availableHeight).x(getX).y((d) {
                    if (!identical(d.display, undefined)) {
                ...
                wrap.select("#nv-edge-clip-" + id + " rect").attr("width", availableWidth).attr("height", availableHeight);
                g.attr("clip-path", clipEdge ? "url(#nv-edge-clip-" + id + ")" : "");
                var area = d3.svg.area().defined(defined).x((d, i) {
                    return x(getX(d, i));
                }).y0((d) {
                    return y(d.display.y0);
                }).y1(areaY1).interpolate(interpolate);
                var zeroArea = d3.svg.area().defined(defined).x((d, i) {
                    return x(getX(d, i));
                }).y0((d) {
                    return y(d.display.y0);
                }).y1((d) {
                ...
                var path = g.select(".nv-areaWrap").selectAll("path.nv-area").data((d) {
                    return d;
                });
                path.enter().append("path").attr("class", (d, i) {
                    ...
                    d3.select(this).classed("hover", true);
                    dispatch.areaMouseover(point: d, series: d.key, pos: [d3.event.pageX, d3.event.pageY], seriesIndex: d.seriesIndex);
                }).on("mouseout", (d, i) {
                    d3.select(this).classed("hover", false);
                    dispatch.areaMouseout(point: d, series: d.key, pos: [d3.event.pageX, d3.event.pageY], seriesIndex: d.seriesIndex);
                }).on("click", (d, i) {
                    d3.select(this).classed("hover", false);
                    dispatch.areaClick(point: d, series: d.key, pos: [d3.event.pageX, d3.event.pageY], seriesIndex: d.seriesIndex);
                });
                path.exit().remove();
                path.style("fill", (d, i) {
                ...
                path.watchTransition(renderWatch, "stackedArea path").attr("d", (d, i) {
                ...
                chart.d3_stackedOffset_stackPercent = (stackData) {
    ...
    nv.models.stackedAreaChart = () {
        ...
        var stateSetter = (data) {
            return (state) {
                if (!identical(state.style, undefined)) style = state.style;
                if (!identical(state.active, undefined)) data.forEach((series, i) {
                    series.disabled = !state.active[i];
                });
            };
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                if (!showLegend) {
                    ...
                    var legendWidth = (showControls && identical(legendPosition, "top")) ? availableWidth - controlWidth : availableWidth;
                    legend.width(legendWidth);
                    g.select(".nv-legendWrap").datum(data).call(legend);
                    if (identical(legendPosition, "bottom")) {
                ...
                if (!showControls) {
                    ...
                    controlsData = controlsData.filter((d) {
                        return !identical(controlOptions.indexOf(d.metaKey), -1);
                    });
                    controls.width(controlWidth).color(["#444", "#444", "#444"]);
                    g.select(".nv-controlsWrap").datum(controlsData).call(controls);
                    var requiredTop = Math.max(controls.height(), showLegend && (identical(legendPosition, "top")) ? legend.height() : 0);
                ...
                g.select(".nv-focus .nv-background rect").attr("width", availableWidth).attr("height", availableHeight);
                stacked.width(availableWidth).height(availableHeight).color(data.map((d, i) {
                    return d.color || color(d, i);
                }).filter((d, i) {
                    return !data[i].disabled;
                }));
                var stackedWrap = g.select(".nv-focus .nv-stackedWrap").datum(data.filter((d) {
                    return !d.disabled;
                }));
                // Setup Axes
                if (showXAxis) {
                ...
                if (showYAxis) {
                    var ticks;
                    if (identical(stacked.offset(), "wiggle")) {
                        ticks = 0;
                    } else {
                ...
                updateYAxis() {
                    if (showYAxis) {
                        if (identical(stacked.style(), "expand") || identical(stacked.style(), "stack_percent")) {
                            var currentFormat = yAxis.tickFormat();
                            if (!oldYTickFormat || !identical(currentFormat, percentFormatter)) oldYTickFormat = currentFormat;
                ...
                if (!focusEnable) {
                    ...
                    focus.width(availableWidth);
                    g.select(".nv-focusWrap").attr("transform", "translate(0," + (availableHeight + margin.bottom + focus.margin().top) + ")").datum(data.filter((d) {
                        return !d.disabled;
                    })).call(focus);
                    var extent = focus.brush.empty() ? focus.xDomain() : focus.brush.extent();
                    if (!identical(extent, null)) {
                ...
                stacked.dispatch.on("areaClick.toggle", (e) {
                    if (identical(data.filter((d) {
                            return !d.disabled;
                        }).length, 1)) data.forEach((d) {
                        d.disabled = false;
                    });
                ...
                interactiveLayer.dispatch.on("elementMousemove", (e) {
                    ...
                    data.filter((series, i) {
                        ...
                        if (identical(i, (data.length - 1)) && !atleastOnePoint) {
                            stacked.highlightPoint(i, pointIndex, true);
                        }
                        if (identical(, "undefined")) return;
                        if (identical(, "undefined")) singlePoint = point;
                        ...
                        allData.push(key: series.key, value: tooltipValue, color: color(series, series.seriesIndex), point: point);
                    ...
                    interactiveLayer.tooltip.valueFormatter(valueFormatter).data(value: xValue, series: allData)();
                    interactiveLayer.renderGuideLine(pointXLocation);
                });
                interactiveLayer.dispatch.on("elementMouseout", (e) {
                    stacked.clearHighlights();
        ...
        //------------------------------------------------------------
        stacked.dispatch.on("elementMouseover.tooltip", (evt) {
            evt.point["x"] = stacked.x()(evt.point);
            evt.point["y"] = stacked.y()(evt.point);
            tooltip.data(evt).hidden(false);
        });
        stacked.dispatch.on("elementMouseout.tooltip", (evt) {
            tooltip.hidden(true);
        });
        //============================================================
        ...
        chart._options = Object.create({}, width: {
            ...
            "set": (_) {
                focus.margin.top = !identical(_.top, undefined) ? _.top : focus.margin.top;
                focus.margin.right = !identical(_.right, undefined) ? _.right : focus.margin.right;
                focus.margin.bottom = !identical(_.bottom, undefined) ? _.bottom : focus.margin.bottom;
                focus.margin.left = !identical(_.left, undefined) ? _.left : focus.margin.left;
            }
    ...
    nv.models.stackedAreaWithFocusChart = () {
    ...
    nv.models.sunburst = () {
        ...
        var margin = {
            ...
            key = (d, i) {
                if (!identical(d.parent, undefined)) {
        ...
        var prevPositions = {};
        var arc = d3.svg.arc().startAngle((d) {
        ...
        computeCenterAngle(d) {
            var startAngle = Math.max(0, Math.min(2 * Math.PI, x(d.x)));
            var endAngle = Math.max(0, Math.min(2 * Math.PI, x(d.x + d.dx)));
            var centerAngle = (((startAngle + endAngle) / 2) * (180 / Math.PI)) - 90;
            return centerAngle;
        }
        computeNodePercentage(d) {
            var startAngle = Math.max(0, Math.min(2 * Math.PI, x(d.x)));
            var endAngle = Math.max(0, Math.min(2 * Math.PI, x(d.x + d.dx)));
            return (endAngle - startAngle) / (2 * Math.PI);
        }
        labelThresholdMatched(d) {
            var startAngle = Math.max(0, Math.min(2 * Math.PI, x(d.x)));
            var endAngle = Math.max(0, Math.min(2 * Math.PI, x(d.x + d.dx)));
        ...
        zoomClick(d) {
            ...
            node = d;
            path.transition().duration(duration).attrTween("d", arcTweenZoom).each("end", (e) {
                ...
                if (e.x >= d.x && e.x < (d.x + d.dx)) {
                    if (e.depth >= d.depth) {
                        ...
                        arcText.transition().duration(duration).text((e) {
                            ...
                            if (identical(e.depth, 0)) return "translate(" + (width / 2 * -1) + ",0)";
                            else if (identical(e.depth, d.depth)) {
        ...
        chart(selection) {
            ...
            selection.each((data) {
                ...
                cGE.append("path").attr("d", arc).style("fill", (d) {
                    if (d.color) {
                        return d.color;
                ...
                }).style("stroke", "#FFF").on("click", (d, i) {
                    zoomClick(d);
                    dispatch.elementClick(data: d, index: i);
                }).on("mouseover", (d, i) {
                    d3.select(this).classed("hover", true).style("opacity", 0.8);
                    dispatch.elementMouseover(data: d, color: d3.select(this).style("fill"), percent: computeNodePercentage(d));
                }).on("mouseout", (d, i) {
                ...
                if (showLabels) {
                    ...
                    cG.append("text").text((e) {
                        return labelFormat(e);
                    }).transition().duration(duration).attr("opacity", (d) {
                        if (labelThresholdMatched(d)) {
                            return 1;
                        } else {
                            return 0;
                ...
                cG.exit().transition().duration(duration).attr("opacity", 0).each("end", (d) {
                    var k = key(d);
    ...
    nv.models.sunburstChart = () {
        ...
        var renderWatch = nv.utils.renderWatch(dispatch);
        tooltip.duration(0).headerEnabled(false).valueFormatter((d) {
            return d;
        });
        ...
        //------------------------------------------------------------
        sunburst.dispatch.on("elementMouseover.tooltip", (evt) {
            evt.series = {
                "key": evt.data.name,
        ...
        sunburst.dispatch.on("elementMouseout.tooltip", (evt) {
            tooltip.hidden(true);
        });
        sunburst.dispatch.on("elementMousemove.tooltip", (evt) {
            tooltip();
        });
        ...
        // use Object get/set functionality to map between vars and chart functions
        chart._options = Object.create({}, noData: {
            "get": () {
                return noData;
            },
            "set": (_) {
